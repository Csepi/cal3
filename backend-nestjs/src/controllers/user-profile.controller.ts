...
export class UserProfileController {
  ...
  async getProfile(@Request() req) {
    const user = await this.userRepository.findOne({
      ...
      select: ['id', 'username', 'email', 'firstName', 'lastName', 'role', 'themeColor', 'weekStartDay', 'defaultCalendarView', 'timezone', 'timeFormat', 'usagePlans', 'hideReservationsTab', 'hiddenResourceIds', 'visibleCalendarIds', 'visibleResourceTypeIds', 'createdAt', 'updatedAt'],
    });
