...
description: Step-by-step guidance for external database connection in PrimeCalendar.
category: Deployment
audience: DevOps
difficulty: Advanced
...
> **Quick Summary**: This page explains external database connection in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete external database connection reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for external database connection.
...
- `external-database/INDEX.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/database-management/external-database-connection.md - Archived snapshot: archives/pre-consolidation/external-database/INDEX.md
