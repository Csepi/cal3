...
description: Step-by-step guidance for self hosted overview in PrimeCalendar.
category: Deployment
audience: DevOps
...
> **Quick Summary**: This page explains self hosted overview in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete self hosted overview reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for self hosted overview.
...
- `07-DEPLOYMENT/production-setup.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/deployment-options/self-hosted-overview.md - Archived snapshot: archives/pre-consolidation/07-DEPLOYMENT/production-setup.md
