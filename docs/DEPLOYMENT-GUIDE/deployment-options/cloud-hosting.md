---
title: Cloud Hosting
description: Step-by-step guidance for cloud hosting in PrimeCalendar.
category: Deployment
audience: DevOps
...
> **Quick Summary**: This page explains cloud hosting in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete cloud hosting reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for cloud hosting.
...
- `07-DEPLOYMENT/azure-swa-containerapps.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/deployment-options/cloud-hosting.md - Archived snapshot: archives/pre-consolidation/07-DEPLOYMENT/azure-swa-containerapps.md
