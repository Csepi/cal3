...
description: Step-by-step guidance for dockerfile reference in PrimeCalendar.
category: Deployment
audience: DevOps
...
> **Quick Summary**: This page explains dockerfile reference in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete dockerfile reference reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for dockerfile reference.
...
- `docker/BUILD_AND_DEBUG.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/docker/dockerfile-reference.md - Archived snapshot: archives/pre-consolidation/docker/BUILD_AND_DEBUG.md
