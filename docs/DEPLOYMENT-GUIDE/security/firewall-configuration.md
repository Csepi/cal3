...
description: Step-by-step guidance for firewall configuration in PrimeCalendar.
category: Deployment
audience: DevOps
difficulty: Advanced
...
> **Quick Summary**: This page explains firewall configuration in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete firewall configuration reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for firewall configuration.
...
- `security/http-hardening.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/security/firewall-configuration.md - Archived snapshot: archives/pre-consolidation/security/http-hardening.md
