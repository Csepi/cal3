...
description: Step-by-step guidance for application monitoring in PrimeCalendar.
category: Deployment
audience: DevOps
...
> **Quick Summary**: This page explains application monitoring in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete application monitoring reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for application monitoring.
...
- `07-DEPLOYMENT/monitoring.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/monitoring-and-logging/application-monitoring.md - Archived snapshot: archives/pre-consolidation/07-DEPLOYMENT/monitoring.md
