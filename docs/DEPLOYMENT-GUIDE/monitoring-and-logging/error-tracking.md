...
description: Step-by-step guidance for error tracking in PrimeCalendar.
category: Deployment
audience: DevOps
...
> **Quick Summary**: This page explains error tracking in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete error tracking reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for error tracking.
...
- `monitoring/ERROR_HANDLING.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/monitoring-and-logging/error-tracking.md - Archived snapshot: archives/pre-consolidation/monitoring/ERROR_HANDLING.md
