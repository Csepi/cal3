...
description: Step-by-step guidance for performance monitoring in PrimeCalendar.
category: Deployment
audience: DevOps
...
> **Quick Summary**: This page explains performance monitoring in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete performance monitoring reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for performance monitoring.
