...
description: Step-by-step guidance for configuration files in PrimeCalendar.
category: Deployment
audience: DevOps
...
> **Quick Summary**: This page explains configuration files in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete configuration files reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for configuration files.
...
- `CONFIGURATION_GUIDE.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/configuration/configuration-files.md - Archived snapshot: archives/pre-consolidation/CONFIGURATION_GUIDE.md
