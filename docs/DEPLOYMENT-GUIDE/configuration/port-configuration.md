...
description: Step-by-step guidance for port configuration in PrimeCalendar.
category: Deployment
audience: DevOps
...
> **Quick Summary**: This page explains port configuration in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete port configuration reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for port configuration.
...
- `PORT_CONFIGURATION.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/configuration/port-configuration.md - Archived snapshot: archives/pre-consolidation/PORT_CONFIGURATION.md
- `SIMPLE_PORT_CONFIG.md`: This page has moved to the consolidated structure. - Canonical page: DEPLOYMENT-GUIDE/configuration/port-configuration.md - Archived snapshot: archives/pre-consolidation/SIMPLE_PORT_CONFIG.md
