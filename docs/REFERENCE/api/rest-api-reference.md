...
description: Step-by-step guidance for rest api reference in PrimeCalendar.
category: Reference
audience: Developer
difficulty: Advanced
...
> **Quick Summary**: This page explains rest api reference in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete rest api reference reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for rest api reference.
...
- `04-API-REFERENCE/error-codes.md`: This page has moved to the consolidated structure. - Canonical page: REFERENCE/api/rest-api-reference.md - Archived snapshot: archives/pre-consolidation/04-API-REFERENCE/error-codes.md
