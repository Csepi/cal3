---
title: Changelog
description: Step-by-step guidance for changelog in PrimeCalendar.
category: Reference
audience: Developer
...
> **Quick Summary**: This page explains changelog in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete changelog reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for changelog.
...
- `releases/tasks-mcp-rollout.md`: This page has moved to the consolidated structure. - Canonical page: REFERENCE/release-notes/changelog.md - Archived snapshot: archives/pre-consolidation/releases/tasks-mcp-rollout.md
