...
description: Step-by-step guidance for migration reference in PrimeCalendar.
category: Reference
audience: Developer
difficulty: Advanced
...
> **Quick Summary**: This page explains migration reference in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete migration reference reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for migration reference.
...
- `external-database/QUICK_REFERENCE.md`: This page has moved to the consolidated structure. - Canonical page: REFERENCE/database/migration-reference.md - Archived snapshot: archives/pre-consolidation/external-database/QUICK_REFERENCE.md
