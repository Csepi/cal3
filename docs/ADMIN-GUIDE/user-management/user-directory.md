...
description: Step-by-step guidance for user directory in PrimeCalendar.
category: Admin
...
> **Quick Summary**: This page explains user directory in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete user directory reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for user directory.
