...
description: Step-by-step guidance for gdpr compliance in PrimeCalendar.
category: Admin
...
> **Quick Summary**: This page explains gdpr compliance in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete gdpr compliance reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for gdpr compliance.
...
- `compliance/GDPR_MODULE.md`: This page has moved to the consolidated structure. - Canonical page: ADMIN-GUIDE/security-and-compliance/gdpr-compliance.md - Archived snapshot: archives/pre-consolidation/compliance/GDPR_MODULE.md
