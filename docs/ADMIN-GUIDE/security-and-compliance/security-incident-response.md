...
description: Step-by-step guidance for security incident response in PrimeCalendar.
category: Admin
...
> **Quick Summary**: This page explains security incident response in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete security incident response reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for security incident response.
...
- `compliance/INCIDENT_RESPONSE.md`: This page has moved to the consolidated structure. - Canonical page: ADMIN-GUIDE/security-and-compliance/security-incident-response.md - Archived snapshot: archives/pre-consolidation/compliance/INCIDENT_RESPONSE.md
