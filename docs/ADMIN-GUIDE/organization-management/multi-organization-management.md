...
description: Step-by-step guidance for multi organization management in PrimeCalendar.
category: Admin
...
> **Quick Summary**: This page explains multi organization management in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete multi organization management reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for multi organization management.
...
- `03-FEATURES/multi-tenancy.md`: This page has moved to the consolidated structure. - Canonical page: ADMIN-GUIDE/organization-management/multi-organization-management.md - Archived snapshot: archives/pre-consolidation/03-FEATURES/multi-tenancy.md
