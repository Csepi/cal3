...
description: Step-by-step guidance for invoices and receipts in PrimeCalendar.
category: Admin
...
> **Quick Summary**: This page explains invoices and receipts in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete invoices and receipts reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for invoices and receipts.
