---
title: Migrations
description: Step-by-step guidance for migrations in PrimeCalendar.
category: Developer
audience: Developer
difficulty: Advanced
...
> **Quick Summary**: This page explains migrations in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete migrations reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for migrations.
...
- `06-DEVELOPER-GUIDES/database-migrations.md`: This page has moved to the consolidated structure. - Canonical page: DEVELOPER-GUIDE/database/migrations.md - Archived snapshot: archives/pre-consolidation/06-DEVELOPER-GUIDES/database-migrations.md
