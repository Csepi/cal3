...
description: Step-by-step guidance for database setup in PrimeCalendar.
category: Developer
audience: Developer
difficulty: Advanced
...
> **Quick Summary**: This page explains database setup in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete database setup reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for database setup.
...
- `database/SECURITY_OPTIMIZATION.md`: This page has moved to the consolidated structure. - Canonical page: DEVELOPER-GUIDE/database/database-setup.md - Archived snapshot: archives/pre-consolidation/database/SECURITY_OPTIMIZATION.md
