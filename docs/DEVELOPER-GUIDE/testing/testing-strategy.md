...
description: Step-by-step guidance for testing strategy in PrimeCalendar.
category: Developer
audience: Developer
...
> **Quick Summary**: This page explains testing strategy in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete testing strategy reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for testing strategy.
...
- `06-DEVELOPER-GUIDES/testing.md`: This page has moved to the consolidated structure. - Canonical page: DEVELOPER-GUIDE/testing/testing-strategy.md - Archived snapshot: archives/pre-consolidation/06-DEVELOPER-GUIDES/testing.md
- `testing/TESTING_STRATEGY.md`: This page has moved to the consolidated structure. - Canonical page: DEVELOPER-GUIDE/testing/testing-strategy.md - Archived snapshot: archives/pre-consolidation/testing/TESTING_STRATEGY.md
