...
description: Step-by-step guidance for frontend architecture in PrimeCalendar.
category: Developer
audience: Developer
difficulty: Advanced
...
> **Quick Summary**: This page explains frontend architecture in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete frontend architecture reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for frontend architecture.
...
- `02-ARCHITECTURE/frontend-structure.md`: This page has moved to the consolidated structure. - Canonical page: DEVELOPER-GUIDE/architecture/frontend-architecture.md - Archived snapshot: archives/pre-consolidation/02-ARCHITECTURE/frontend-structure.md
