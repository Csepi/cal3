...
description: Step-by-step guidance for system overview in PrimeCalendar.
category: Developer
audience: Developer
difficulty: Advanced
...
> **Quick Summary**: This page explains system overview in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete system overview reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for system overview.
...
- `02-ARCHITECTURE/system-overview.md`: This page has moved to the consolidated structure. - Canonical page: DEVELOPER-GUIDE/architecture/system-overview.md - Archived snapshot: archives/pre-consolidation/02-ARCHITECTURE/system-overview.md
- `architecture/agent-integration-plan.md`: This page has moved to the consolidated structure. - Canonical page: DEVELOPER-GUIDE/architecture/system-overview.md - Archived snapshot: archives/pre-consolidation/architecture/agent-integration-plan.md
