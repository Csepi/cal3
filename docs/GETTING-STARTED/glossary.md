---
title: Glossary
description: Step-by-step guidance for glossary in PrimeCalendar.
...
> **Quick Summary**: This page explains glossary in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete glossary reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for glossary.
...
- `GLOSSARY.md`: This page has moved to the consolidated structure. - Canonical page: GETTING-STARTED/glossary.md - Archived snapshot: archives/pre-consolidation/GLOSSARY.md
