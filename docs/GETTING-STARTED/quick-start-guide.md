...
description: Step-by-step guidance for quick start guide in PrimeCalendar.
...
related:
  - index.md
  - ../index.md
tags: [getting, started, quick, start, primecalendar]
---

# Quick Start Guide

> **Quick Summary**: This page explains quick start guide in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete quick start guide reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for quick start guide.
...
- `QUICKSTART.md`: This page has moved to the consolidated structure. - Canonical page: GETTING-STARTED/quick-start-guide.md - Archived snapshot: archives/pre-consolidation/QUICKSTART.md
