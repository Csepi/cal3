...
description: Step-by-step guidance for backend debugging in PrimeCalendar.
...
> **Quick Summary**: This page explains backend debugging in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete backend debugging reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for backend debugging.
...
- `06-DEVELOPER-GUIDES/debugging.md`: This page has moved to the consolidated structure. - Canonical page: TROUBLESHOOTING/debugging-guides/backend-debugging.md - Archived snapshot: archives/pre-consolidation/06-DEVELOPER-GUIDES/debugging.md
- `09-TROUBLESHOOTING/logs-debugging.md`: This page has moved to the consolidated structure. - Canonical page: TROUBLESHOOTING/debugging-guides/backend-debugging.md - Archived snapshot: archives/pre-consolidation/09-TROUBLESHOOTING/logs-debugging.md
