...
description: Step-by-step guidance for mobile app issues in PrimeCalendar.
...
> **Quick Summary**: This page explains mobile app issues in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete mobile app issues reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for mobile app issues.
...
- `09-TROUBLESHOOTING/smart-home-issues.md`: This page has moved to the consolidated structure. - Canonical page: TROUBLESHOOTING/common-issues/mobile-app-issues.md - Archived snapshot: archives/pre-consolidation/09-TROUBLESHOOTING/smart-home-issues.md
