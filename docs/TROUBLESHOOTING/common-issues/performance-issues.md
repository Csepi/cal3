...
description: Step-by-step guidance for performance issues in PrimeCalendar.
...
> **Quick Summary**: This page explains performance issues in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete performance issues reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for performance issues.
...
- `09-TROUBLESHOOTING/performance-issues.md`: This page has moved to the consolidated structure. - Canonical page: TROUBLESHOOTING/common-issues/performance-issues.md - Archived snapshot: archives/pre-consolidation/09-TROUBLESHOOTING/performance-issues.md
