...
description: Step-by-step guidance for mobile app overview in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains mobile app overview in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete mobile app overview reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for mobile app overview.
...
- `MOBILE_APP.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/mobile-app/mobile-app-overview.md - Archived snapshot: archives/pre-consolidation/MOBILE_APP.md
