...
description: Step-by-step guidance for managing bookings in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains managing bookings in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete managing bookings reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for managing bookings.
...
- `03-FEATURES/public-booking.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/public-booking/managing-bookings.md - Archived snapshot: archives/pre-consolidation/03-FEATURES/public-booking.md
