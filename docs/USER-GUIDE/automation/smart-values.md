---
title: Smart Values
description: Step-by-step guidance for smart values in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains smart values in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete smart values reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for smart values.
...
- `automation-smart-values.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/automation/smart-values.md - Archived snapshot: archives/pre-consolidation/automation-smart-values.md
