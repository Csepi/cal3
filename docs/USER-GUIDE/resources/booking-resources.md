...
description: Step-by-step guidance for booking resources in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains booking resources in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete booking resources reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for booking resources.
...
- `03-FEATURES/reservations.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/resources/booking-resources.md - Archived snapshot: archives/pre-consolidation/03-FEATURES/reservations.md
- `05-USER-GUIDES/reservations-guide.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/resources/booking-resources.md - Archived snapshot: archives/pre-consolidation/05-USER-GUIDES/reservations-guide.md
