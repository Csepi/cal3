...
description: Step-by-step guidance for resource management in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains resource management in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete resource management reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for resource management.
...
- `03-FEATURES/resources.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/resources/resource-management.md - Archived snapshot: archives/pre-consolidation/03-FEATURES/resources.md
