---
title: Managing External Attendees
description: Step-by-step guidance for managing external attendees in PrimeCalendar.
category: User Guide
audience: End User
...
# Managing External Attendees

> **Quick Summary**: This page explains managing external attendees in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete managing external attendees reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for managing external attendees.
