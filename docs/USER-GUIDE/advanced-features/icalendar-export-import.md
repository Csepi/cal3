...
description: Step-by-step guidance for icalendar export import in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains icalendar export import in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete icalendar export import reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for icalendar export import.
...
- `08-MIGRATION/data-import.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/advanced-features/icalendar-export-import.md - Archived snapshot: archives/pre-consolidation/08-MIGRATION/data-import.md
