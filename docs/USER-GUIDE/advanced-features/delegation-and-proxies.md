...
description: Step-by-step guidance for delegation and proxies in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains delegation and proxies in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete delegation and proxies reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for delegation and proxies.
...
- `03-FEATURES/smart-home.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/advanced-features/delegation-and-proxies.md - Archived snapshot: archives/pre-consolidation/03-FEATURES/smart-home.md
- `05-USER-GUIDES/smart-home-guide.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/advanced-features/delegation-and-proxies.md - Archived snapshot: archives/pre-consolidation/05-USER-GUIDES/smart-home-guide.md
