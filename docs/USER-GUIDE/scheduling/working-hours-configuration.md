...
description: Step-by-step guidance for working hours configuration in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains working hours configuration in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete working hours configuration reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for working hours configuration.
