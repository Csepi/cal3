...
- `03-FEATURES/sync-integrations.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/integrations/custom-integrations.md - Archived snapshot: archives/pre-consolidation/03-FEATURES/sync-integrations.md
