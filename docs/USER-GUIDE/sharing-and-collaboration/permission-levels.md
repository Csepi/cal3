...
description: Step-by-step guidance for permission levels in PrimeCalendar.
category: User Guide
audience: End User
...
> **Quick Summary**: This page explains permission levels in PrimeCalendar using practical steps and troubleshooting guidance.
...
Use this guide to complete permission levels reliably. Confirm expected results after each step before moving to optional advanced settings.
...
**Scenario**: Your team needs consistent behavior for permission levels.
...
- `05-USER-GUIDES/sharing-permissions.md`: This page has moved to the consolidated structure. - Canonical page: USER-GUIDE/sharing-and-collaboration/permission-levels.md - Archived snapshot: archives/pre-consolidation/05-USER-GUIDES/sharing-permissions.md
