...
const SystemInfoPage: React.FC = () => {
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600">{tStatic('common:auto.frontend.kee3dfbaa66eb')}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 p-6">
        <div className="max-w-4xl mx-auto">
          <ErrorBox
            error={error}
            title={tStatic('common:auto.frontend.k4e24cddab612')}
            onClose={() => {
              setError(null);
  ...
  if (!systemInfo) {
    return <div>{tStatic('common:auto.frontend.k2279cb059d50')}</div>;
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200">
        ...
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-semibold text-blue-900">
              {tStatic('common:auto.frontend.kcda223eb76ca')}</h1>
          </div>
          <button
      ...
      <main className="relative z-10 max-w-7xl mx-auto p-6 mt-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <span className="text-sm text-gray-600">{tStatic('common:auto.frontend.ka3e2c8c550fc')}</span>
            <p className="text-2xl font-bold text-blue-600">v{systemInfo.version}</p>
          </div>
          <div className="text-right">
            <span className="text-sm text-gray-600">{tStatic('common:auto.frontend.k66f3e18075fb')}</span>
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800 flex items-center">
            ...
            {tStatic('common:auto.frontend.k25d0ba9c9da5')}</h2>
        </div>
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k0dc2614c3f82')}</label>
            <p className="text-lg font-semibold text-gray-900">{systemInfo.server.nodeVersion}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k123a7f2fcc9a')}</label>
            <p className="text-lg font-semibold text-gray-900">{systemInfo.server.platform}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.kb040b4179b8b')}</label>
            <p className="text-lg font-semibold text-gray-900">{systemInfo.server.architecture}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k6aafa80cab6f')}</label>
            <p className="text-lg font-semibold text-gray-900">{formatUptime(systemInfo.server.uptime)}</p>
          </div>

          {/* Memory Usage */}
          <div className="md:col-span-2">
            <label className="text-sm font-medium text-gray-600 block mb-2">{tStatic('common:auto.frontend.k03a68b7d8b85')}</label>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                <p className="text-xs text-gray-600">{tStatic('common:auto.frontend.k77611b769f50')}</p>
                <p className="text-lg font-bold text-blue-600">{formatBytes(systemInfo.server.memoryUsage.heapUsed)}</p>
              </div>
              <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
                <p className="text-xs text-gray-600">{tStatic('common:auto.frontend.kc72741751c07')}</p>
                <p className="text-lg font-bold text-purple-600">{formatBytes(systemInfo.server.memoryUsage.heapTotal)}</p>
              </div>
              <div className="bg-green-50 rounded-lg p-3 border border-green-200">
                <p className="text-xs text-gray-600">{tStatic('common:auto.frontend.k8d10c693b773')}</p>
                <p className="text-lg font-bold text-green-600">{formatBytes(systemInfo.server.memoryUsage.external)}</p>
              </div>
              <div className="bg-orange-50 rounded-lg p-3 border border-orange-200">
                <p className="text-xs text-gray-600">{tStatic('common:auto.frontend.kfcae0f074817')}</p>
          ...
          {/* CPU Usage */}
          <div className="md:col-span-2">
            <label className="text-sm font-medium text-gray-600 block mb-2">{tStatic('common:auto.frontend.kc4922b4ba805')}</label>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-red-50 rounded-lg p-3 border border-red-200">
                <p className="text-xs text-gray-600">{tStatic('common:auto.frontend.k9f8a2389a20c')}</p>
                <p className="text-lg font-bold text-red-600">{systemInfo.server.cpuUsage.user}{tStatic('common:auto.frontend.k26cc3217be64')}</p>
              </div>
              <div className="bg-yellow-50 rounded-lg p-3 border border-yellow-200">
                <p className="text-xs text-gray-600">{tStatic('common:auto.frontend.kbc0792d8dc81')}</p>
                <p className="text-lg font-bold text-yellow-600">{systemInfo.server.cpuUsage.system}{tStatic('common:auto.frontend.k26cc3217be64')}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800 flex items-center">
            ...
            {tStatic('common:auto.frontend.kc2a3520c849d')}</h2>
        </div>
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k96b91d22096c')}</label>
            <p className="text-lg font-semibold text-gray-900 uppercase">{systemInfo.database.type}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k3960ec4ca5fb')}</label>
          ...
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.kfe035157cda2')}</label>
            <p className="text-lg font-semibold text-gray-900">{systemInfo.database.port}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k659d0cba949d')}</label>
            <p className="text-lg font-semibold text-gray-900">{systemInfo.database.database}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.kf75e60337e7f')}</label>
            <p className="text-lg font-semibold">
              {systemInfo.database.ssl ? (
                <span className="text-green-600 flex items-center">
                  ...
                  {tStatic('common:auto.frontend.k5397e0583f14')}</span>
              ) : (
                <span className="text-red-600">{tStatic('common:auto.frontend.k816c52fd2bdd')}</span>
              )}
            </p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.kc195e4374c85')}</label>
            <p className="text-lg font-semibold">
              {systemInfo.database.synchronized ? (
                <span className="text-yellow-600">{tStatic('common:auto.frontend.k76588726c227')}</span>
              ) : (
                <span className="text-green-600">{tStatic('common:auto.frontend.kaca7818086c7')}</span>
              )}
            </p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k7f9c4306f84d')}</label>
            <p className="text-lg font-semibold text-gray-900">
              {tStatic('common:auto.frontend.k21be6e4ee37c')}{systemInfo.database.poolMin} {tStatic('common:auto.frontend.k02d93160b085')}{systemInfo.database.poolMax}
            </p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.kd3c9a5b98052')}</label>
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800 flex items-center">
            ...
            {tStatic('common:auto.frontend.k7e24ea2a1abb')}</h2>
        </div>
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k40a5a0252ead')}</label>
            <p className="text-lg font-semibold">
          ...
          <div>
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k24ea3146c3e8')}</label>
            <p className="text-lg font-semibold text-gray-900">{systemInfo.environment.port}</p>
          </div>
          <div className="md:col-span-2">
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k1dbd61f556fe')}</label>
            <p className="text-lg font-semibold text-blue-600 truncate">{systemInfo.environment.baseUrl}</p>
          </div>
          <div className="md:col-span-2">
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.ke7381c758a35')}</label>
            <p className="text-lg font-semibold text-blue-600 truncate">{systemInfo.environment.frontendUrl}</p>
          </div>
          <div className="md:col-span-2">
            <label className="text-sm font-medium text-gray-600">{tStatic('common:auto.frontend.k61290c201515')}</label>
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800 flex items-center">
            ...
            {tStatic('common:auto.frontend.k4f5a54627dea')}</h2>
        </div>
        ...
        <div className="p-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div className="bg-orange-50 rounded-lg p-4 border border-orange-200 text-center">
            <p className="text-sm text-gray-600">{tStatic('common:auto.frontend.kfe5c54bbae46')}</p>
          ...
          <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-200 text-center">
            <p className="text-sm text-gray-600">{tStatic('common:auto.frontend.kabbff7944d5d')}</p>
          ...
          <div className="bg-teal-50 rounded-lg p-4 border border-teal-200 text-center">
            <p className="text-sm text-gray-600">{tStatic('common:auto.frontend.k2d536b9ad494')}</p>
