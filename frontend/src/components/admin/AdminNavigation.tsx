    ...
    >
      <div className="px-6 py-5 border-b border-gray-200">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white font-semibold">
            {tStatic('common:auto.frontend.k6d95c1847219')}</div>
          <div>
            <p className="text-xs uppercase tracking-wide text-gray-500">{tStatic('common:auto.frontend.ke854998a94e3')}</p>
            <h1 className="text-lg font-semibold text-gray-900">{tStatic('common:auto.frontend.kc312449c8d61')}</h1>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-4 border-t border-gray-200 bg-gray-50/70 rounded-b-3xl">
        <p className="text-xs text-gray-500">
          {tStatic('common:auto.frontend.k6c60cca5619d')}{' '}
