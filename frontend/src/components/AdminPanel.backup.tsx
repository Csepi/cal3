...
/**
 * AdminPanel component - Main admin panel interface
 *
 * This component has been refactored into a modular architecture using
 * specialized components for different admin functions. It now acts as
 * an orchestrator that manages navigation and renders appropriate panels.
 */
