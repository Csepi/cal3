---
title: "PrimeCal Dokumentáció"
description: "Kezdje a regisztrációval, térjen át a napi tervezésre, majd folytassa az automatizálással, a MCP, a szinkronizálással és a teljes API hivatkozással."
...
<div class="pc-guide-hero">
  ...
  <p class="pc-guide-hero__lead">Kezdje a regisztrációval és a beállítással, lépjen tovább a mindennapi PrimeCal munkaterületre, majd térjen át az automatizálásra, a külső szinkronizálásra, az AI-ügynökökre és a teljes fejlesztői hivatkozásra.</p>
  <div class="pc-guide-chip-row">
    <span class="pc-guide-chip">Valódi termék képernyőképek</span>
    <span class="pc-guide-chip">PrimeCal színrendszer</span>
    <span class="pc-guide-chip">Felhasználói struktúra</span>
    <span class="pc-guide-chip">Kóddal támogatott API dokumentumok</span>
  </div>
</div>
...
<p>Kezdje a <Link to="/GETTING-STARTED/quick-start-guide">Gyors üzembe helyezési útmutatóval</Link> és a részletes regisztrációs útmutatóval.</p>
  ...
  <article class="pc-guide-flow__item">
    ...
    <p>Fejezze be profilját, hozzon létre valódi naptárakat, csoportosítsa őket, és állítsa be a Fókusz módot a terv szerint.</p>
  </article>
  <article class="pc-guide-flow__item">
    <div class="pc-guide-flow__index">3</div>
    <h3>Napi munka futtatása</h3>
    <p>Használja a naptárakat, eseményeket, feladatokat és személyes naplókat a valódi felhasználók normál munkafelületeként.</p>
  </article>
  <article class="pc-guide-flow__item">
    <div class="pc-guide-flow__index">4</div>
    <h3>Energiafunkciók hozzáadása</h3>
    <p>Ha a kézi munka ismétlődik, lépjen át az automatizálásra, a külső szinkronizálásra és az AI-ügynökökre.</p>
  </article>
  <article class="pc-guide-flow__item">
    <div class="pc-guide-flow__index">5</div>
    <h3>Build Integrations</h3>
    <p>Használja a fejlesztői útmutatót, ha háttérszerződésekre, példákra, korlátozásokra és nem rendszergazdai API lefedettségre van szüksége.</p>
  </article>
</div>
