---
title: "Kubernetes telepítés"
description: "Lépésről lépésre útmutató a kubernetes telepítéséhez a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Haladó"
...
# Kubernetes telepítés {#kubernetes-deployment}

> **Gyors összefoglaló**: Ez az oldal a kubernetes telepítését ismerteti a PrimeCalendar rendszerben gyakorlati lépésekkel és hibaelhárítási útmutatóval.
...
Használja ezt az útmutatót a kubernetes telepítésének megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a kubernetes telepítéséhez.
