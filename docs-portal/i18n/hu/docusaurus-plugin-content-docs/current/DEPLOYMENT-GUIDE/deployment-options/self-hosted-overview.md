---
title: "Self Hosted áttekintése"
description: "Lépésről lépésre útmutatás a saját üzemeltetésű áttekintéshez itt: PrimeCalendar."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
# Self Hosted áttekintése {#self-hosted-overview}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar saját üzemeltetésű áttekintését ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a saját üzemeltetésű áttekintés megbízható elkészítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes magatartásra van szüksége a saját tárhely áttekintéséhez.
...
- `07-DEPLOYMENT/production-setup.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEPLOYMENT-GUIDE/deployment-options/self-hosted-overview.md - Archivált pillanatkép: archives/pre-consolidation/07-DEPLOYMENT/production-setup.md
