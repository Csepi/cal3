---
title: "Helm Charts"
description: "Lépésről lépésre útmutató a kormánydiagramokhoz a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Haladó"
...
> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar kormánydiagramjait ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a kormánytáblázatok megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a kormánytáblázatokhoz.
