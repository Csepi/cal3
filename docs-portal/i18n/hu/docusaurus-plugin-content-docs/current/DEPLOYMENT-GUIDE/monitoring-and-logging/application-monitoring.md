---
title: "Alkalmazásfigyelés"
description: "Lépésről lépésre útmutató az alkalmazások figyeléséhez a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, monitoring, and, logging, application, primecalendar]
---

# Alkalmazásfigyelés {#application-monitoring}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar alkalmazásfigyelését ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az alkalmazásfelügyelet megbízható elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége az alkalmazások figyeléséhez.
...
- `07-DEPLOYMENT/monitoring.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEPLOYMENT-GUIDE/monitoring-and-logging/application-monitoring.md - Archivált pillanatkép: archívum/pre-consolidation/07-DEPLOYMENT/monitoring.md
