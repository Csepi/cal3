---
title: "Napló összesítés"
description: "Lépésről lépésre a naplóösszesítéshez a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
# Napló összesítés {#log-aggregation}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar naplóösszesítését ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a naplóösszesítés megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a naplóösszesítéshez.
