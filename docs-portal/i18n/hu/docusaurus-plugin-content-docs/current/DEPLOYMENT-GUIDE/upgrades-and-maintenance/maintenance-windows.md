---
title: "Karbantartási ablakok"
description: "Lépésről lépésre útmutató a karbantartási ablakokhoz a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, upgrades, and, maintenance, windows, primecalendar]
---

# Karbantartási ablakok {#maintenance-windows}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar karbantartási ablakait ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a karbantartási ablakok megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a karbantartási időszakokhoz.
