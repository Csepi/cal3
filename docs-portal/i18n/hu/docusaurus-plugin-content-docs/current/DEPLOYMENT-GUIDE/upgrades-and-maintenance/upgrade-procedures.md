---
title: "Frissítési eljárások"
description: "A PrimeCalendar frissítési eljárásaihoz lépésről lépésre szóló útmutató."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
# Frissítési eljárások {#upgrade-procedures}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar frissítési eljárásait ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a frissítési eljárások megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes magatartásra van szüksége a frissítési eljárásokhoz.
...
- `06-DEVELOPER-GUIDES/deployment.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEPLOYMENT-GUIDE/upgrades-and-maintainance/upgrade-procedures.md - Archivált pillanatkép: archív/pre-consolidation/06-DEVELOPER-GUIDES/deployment.md
- `07-DEPLOYMENT/git-push-auto-upgrade.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEPLOYMENT-GUIDE/upgrades-and-maintenance/upgrade-procedures.md - Archivált pillanatkép: archív/pre-consolidation/07-DEPLOYMENT/git-push-auto-upgrade.md
- `08-MIGRATION/from-datacenter.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEPLOYMENT-GUIDE/upgrades-and-maintainance/upgrade-procedures.md - Archivált pillanatkép: archívum/pre-consolidation/08-MIGRATION/from-datacenter.md
