---
title: "Nulla állásidő telepítés"
description: "Lépésről lépésre útmutatás az állásidő nélküli telepítéshez a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
# Nulla állásidő telepítés {#zero-downtime-deployment}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar leállás nélküli üzembe helyezését ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatóval.
...
Használja ezt az útmutatót az állásidő nélküli üzembe helyezés megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatának következetes viselkedésre van szüksége a leállás nélküli üzembe helyezés érdekében.
