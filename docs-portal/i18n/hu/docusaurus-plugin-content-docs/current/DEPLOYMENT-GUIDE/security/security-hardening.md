---
title: "Biztonsági keményedés"
description: "Lépésről lépésre a biztonsági szigorításhoz a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Haladó"
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, security, hardening, primecalendar]
---

# Biztonsági keményedés {#security-hardening}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar biztonsági szigorítását ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a biztonsági szigorítás megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A biztonsági szigorítás érdekében csapatának következetes magatartásra van szüksége.
...
- `07-DEPLOYMENT/security.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: BEVEZETÉS-ÚTMUTATÓ/security/security-hardening.md - Archivált pillanatkép: archív/pre-consolidation/07-DEPLOYMENT/security.md
- `security/data-layer-hardening.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: BEVEZETÉSI ÚTMUTATÓ/security/security-hardening.md - Archivált pillanatkép: archívum/pre-consolidation/security/data-layer-hardening.md
