---
title: "Dockerfile hivatkozás"
description: "Lépésről lépésre útmutató a dockerfile hivatkozáshoz a PrimeCalendar dokumentumban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
# Dockerfile hivatkozás {#dockerfile-reference}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar dockerfile-referenciáját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a dockerfile hivatkozás megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatának konzisztens viselkedésre van szüksége a dockerfile hivatkozáshoz.
...
- `docker/BUILD_AND_DEBUG.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEPLOYMENT-GUIDE/docker/dockerfile-reference.md - Archivált pillanatkép: archív/pre-consolidation/docker/BUILD_AND_DEBUG.md
