---
title: "SSL tanúsítványok"
description: "Lépésről lépésre útmutató az ssl-tanúsítványokhoz a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, infrastructure, ssl, certificates, primecalendar]
---

# SSL tanúsítványok {#ssl-certificates}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar ssl-tanúsítványait ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az ssl-tanúsítványok megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége az ssl-tanúsítványokhoz.
