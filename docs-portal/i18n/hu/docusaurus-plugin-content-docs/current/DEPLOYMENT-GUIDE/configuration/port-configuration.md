---
title: "Port konfiguráció"
description: "Lépésről lépésre a portkonfigurációhoz a PrimeCalendar-ban."
category: "Telepítés"
audience: "DevOps"
difficulty: "Közepes"
...
# Port konfiguráció {#port-configuration}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar portkonfigurációját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a portkonfiguráció megbízható elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a portkonfigurációhoz.
...
- `PORT_CONFIGURATION.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEPLOYMENT-GUIDE/configuration/port-configuration.md - Archivált pillanatkép: archives/pre-consolidation/PORT_CONFIGURATION.md
- `SIMPLE_PORT_CONFIG.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEPLOYMENT-GUIDE/configuration/port-configuration.md - Archivált pillanatkép: archives/pre-consolidation/SIMPLE_PORT_CONFIG.md
