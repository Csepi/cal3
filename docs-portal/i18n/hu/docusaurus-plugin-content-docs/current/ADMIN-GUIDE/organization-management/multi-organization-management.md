---
title: "Több szervezet menedzsment"
description: "Lépésről lépésre útmutató több szervezet kezeléséhez a PrimeCalendar-ban."
category: "Admin"
...
# Több szervezet menedzsment {#multi-organization-management}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar több szervezet kezelését ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a több szervezet kezelésének megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes magatartásra van szüksége a több szervezet irányítása érdekében.
...
- `03-FEATURES/multi-tenancy.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: ADMIN-GUIDE/organization-management/multi-organization-management.md - Archivált pillanatkép: archív/pre-consolidation/03-FEATURES/multi-tenancy.md
