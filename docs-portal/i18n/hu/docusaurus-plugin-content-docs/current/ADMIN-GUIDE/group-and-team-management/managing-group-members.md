---
title: "Csoporttagok irányítása"
description: "Lépésről lépésre szóló útmutató a csoporttagok kezeléséhez a PrimeCalendar-ban."
category: "Admin"
...
# Csoporttagok irányítása {#managing-group-members}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar csoporttagok kezelését ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a csoporttagok megbízható kezeléséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes magatartásra van szüksége a csoporttagok kezeléséhez.
