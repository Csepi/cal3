---
title: "Osztályi hierarchiák"
description: "Lépésről lépésre útmutató a PrimeCalendar osztályhierarchiájához."
category: "Admin"
...
# Osztályi hierarchiák {#department-hierarchies}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar osztályok hierarchiáit ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a részleghierarchiák megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a részleghierarchiákhoz.
