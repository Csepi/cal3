...
description: "A PrimeCalendar csoportengedélyeihez lépésről lépésre szóló útmutató."
category: "Admin"
...
# Csoportengedélyek {#group-permissions}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar csoportengedélyeit ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a csoportengedélyek megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csoportnak következetes viselkedésre van szüksége a csoportengedélyekhez.
