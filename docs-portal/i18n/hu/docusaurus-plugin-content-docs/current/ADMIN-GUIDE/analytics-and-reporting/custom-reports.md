...
description: "Lépésről lépésre az egyéni jelentések elkészítéséhez itt: PrimeCalendar."
category: "Admin"
...
# Egyéni jelentések {#custom-reports}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar egyéni jelentéseit ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az egyéni jelentések megbízható elkészítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége az egyéni jelentések készítéséhez.
