---
title: "Felhasználók deaktiválása"
description: "Lépésről lépésre útmutató a felhasználók deaktiválásához a PrimeCalendar alkalmazásban."
category: "Admin"
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, user, management, deactivating, users, primecalendar]
---

# Felhasználók deaktiválása {#deactivating-users}

> **Gyors összefoglaló**: Ez az oldal a felhasználók deaktiválását ismerteti a PrimeCalendar alkalmazásban gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a felhasználók deaktiválásának megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a felhasználók deaktiválásához.
