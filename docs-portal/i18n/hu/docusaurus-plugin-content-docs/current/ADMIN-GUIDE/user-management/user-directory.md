---
title: "Felhasználói címtár"
description: "Lépésről lépésre útmutató a PrimeCalendar felhasználói címtárához."
category: "Admin"
...
# Felhasználói címtár {#user-directory}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar felhasználói címtárát ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a felhasználói címtár megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a felhasználói címtárhoz.
