...
description: "Lépésről lépésre a felhasználók meghívásához a PrimeCalendar-ban."
category: "Admin"
...
# Felhasználók meghívása {#inviting-users}

> **Gyors összefoglaló**: Ez az oldal gyakorlati lépésekkel és hibaelhárítási útmutatásokkal ismerteti a felhasználók meghívását a PrimeCalendar programba.
...
Használja ezt az útmutatót a felhasználók meghívásának megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes magatartásra van szüksége a felhasználók meghívásához.
