---
title: "Felhasználói szerepkörök és engedélyek"
description: "Lépésről lépésre útmutató a felhasználói szerepkörökhöz és engedélyekhez a PrimeCalendar-ban."
category: "Admin"
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, user, management, roles, and, permissions, primecalendar]
---

# Felhasználói szerepkörök és engedélyek {#user-roles-and-permissions}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar felhasználói szerepköreit és jogosultságait ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a felhasználói szerepkörök és engedélyek megbízható teljesítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a felhasználói szerepkörök és engedélyek tekintetében.
