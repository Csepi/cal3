---
title: "Béta funkciók engedélyezése"
description: "Lépésről lépésre a bétafunkciók engedélyezéséhez a PrimeCalendar-ban."
category: "Admin"
...
# Béta funkciók engedélyezése {#enabling-beta-features}

> **Gyors összefoglaló**: Ez az oldal a bétafunkciók engedélyezését ismerteti a PrimeCalendar alkalmazásban gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a béta funkciók engedélyezésének megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a béta funkciók engedélyezéséhez.
