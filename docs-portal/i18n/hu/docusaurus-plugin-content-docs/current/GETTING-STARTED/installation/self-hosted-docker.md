...
description: "Lépésről lépésre útmutató saját üzemeltetésű dokkolóhoz a PrimeCalendar-ban."
...
> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar saját üzemeltetésű dokkolóját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a saját üzemeltetésű dokkoló megbízható teljesítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatának következetes viselkedésre van szüksége a saját üzemeltetésű dokkoló számára.
...
- `01-GETTING-STARTED/docker-setup.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: GETTING-STARTED/installation/self-hosted-docker.md - Archivált pillanatkép: archives/pre-consolidation/01-GETTING-STARTED/docker-setup.md
