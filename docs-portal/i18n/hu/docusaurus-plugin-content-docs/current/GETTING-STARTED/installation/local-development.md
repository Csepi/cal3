---
title: "Helyi fejlesztés"
description: "Lépésről lépésre útmutató a helyi fejlesztéshez a PrimeCalendar-ban."
...
> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar helyi fejlesztését ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a helyi fejlesztés megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes magatartásra van szüksége a helyi fejlődéshez.
...
- `01-GETTING-STARTED/database-setup.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: GETTING-STARTED/installation/local-development.md - Archivált pillanatkép: archives/pre-consolidation/01-GETTING-STARTED/database-setup.md
- `01-GETTING-STARTED/installation.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: GETTING-STARTED/installation/local-development.md - Archivált pillanatkép: archives/pre-consolidation/01-GETTING-STARTED/installation.md
