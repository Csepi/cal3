---
title: "Változásnapló"
description: "Lépésről lépésre útmutató a változásnaplóhoz a PrimeCalendar-ban."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar változásnaplóját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a változásnapló megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a változásnaplóhoz.
...
- `releases/tasks-mcp-rollout.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: REFERENCE/release-notes/changelog.md - Archivált pillanatkép: archives/pre-consolidation/releases/tasks-mcp-rollout.md
