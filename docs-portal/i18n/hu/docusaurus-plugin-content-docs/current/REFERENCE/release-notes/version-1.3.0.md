---
title: "1.3.0 verzió"
description: "Lépésről lépésre útmutató az 1.3.0-s verzióhoz itt: PrimeCalendar."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, release, notes, version, 1.3.0, primecalendar]
---

# 1.3.0 verzió {#version-130}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar 1.3.0-s verzióját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az 1.3.0 verzió megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége az 1.3.0-s verzióhoz.
