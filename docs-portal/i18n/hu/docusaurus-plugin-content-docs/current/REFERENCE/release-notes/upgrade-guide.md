...
description: "A PrimeCalendar frissítési útmutatója lépésről lépésre."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Frissítési útmutató {#upgrade-guide}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar frissítési útmutatóját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a frissítési útmutató megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A frissítési útmutatóhoz csapatának következetes magatartásra van szüksége.
