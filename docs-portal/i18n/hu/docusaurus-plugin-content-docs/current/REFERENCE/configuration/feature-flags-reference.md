...
description: "Lépésről lépésre útmutató a szolgáltatásjelzők hivatkozásához a PrimeCalendar dokumentumban."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar szolgáltatásjelzőire vonatkozó hivatkozásokat ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a jellemzőjelzők hivatkozásának megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a funkciójelzők hivatkozásához.
