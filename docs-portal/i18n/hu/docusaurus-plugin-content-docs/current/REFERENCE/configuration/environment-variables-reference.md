---
title: "Környezeti változók hivatkozása"
description: "Lépésről lépésre útmutató a környezeti változók hivatkozásához a PrimeCalendar dokumentumban."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Környezeti változók hivatkozása {#environment-variables-reference}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar környezeti változókra vonatkozó hivatkozásokat ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a környezeti változókra való hivatkozás megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak konzisztens viselkedésre van szüksége a környezeti változókra való hivatkozáshoz.
