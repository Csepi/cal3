---
title: "Akció referencia"
description: "Lépésről lépésre útmutató a műveletekhez a PrimeCalendar dokumentumban."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Akció referencia {#action-reference}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar műveletre vonatkozó hivatkozásokat ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a műveleti referencia megbízható elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a cselekvési referenciaként.
