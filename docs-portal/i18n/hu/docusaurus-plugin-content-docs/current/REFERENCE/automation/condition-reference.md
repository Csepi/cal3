---
title: "Állapot referencia"
description: "Lépésről lépésre útmutató a feltételreferenciához itt: PrimeCalendar."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Állapot referencia {#condition-reference}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar állapothivatkozását ismerteti gyakorlati lépések és hibaelhárítási útmutató segítségével.
...
Használja ezt az útmutatót az állapotreferencia megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak konzisztens viselkedésre van szüksége az állapot referenciaként.
