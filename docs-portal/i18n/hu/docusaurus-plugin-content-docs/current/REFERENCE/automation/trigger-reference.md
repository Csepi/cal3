---
title: "Trigger referencia"
description: "Lépésről lépésre útmutató a triggerreferenciához itt: PrimeCalendar."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Trigger referencia {#trigger-reference}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar eseményindító hivatkozását ismerteti gyakorlati lépések és hibaelhárítási útmutató segítségével.
...
Használja ezt az útmutatót a trigger referencia megbízható teljesítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a kiváltó hivatkozáshoz.
