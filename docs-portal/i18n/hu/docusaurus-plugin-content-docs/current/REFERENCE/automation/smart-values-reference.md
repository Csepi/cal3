---
title: "Intelligens értékek referencia"
description: "Lépésről lépésre útmutatás az intelligens értékekhez a PrimeCalendar-ban."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Intelligens értékek referencia {#smart-values-reference}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar intelligens értékekre vonatkozó hivatkozásokat ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az intelligens értékekre való hivatkozás megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes magatartásra van szüksége az intelligens értékekre való hivatkozáshoz.
