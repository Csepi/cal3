---
title: "Rest API Hivatkozás"
description: "Lépésről lépésre útmutató a rest api-referenciához a PrimeCalendar-ban."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Haladó"
...
# Rest API Hivatkozás {#rest-api-reference}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar többi api-referenciáját ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a rest api referencia megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a rest api referenciaként.
...
- `04-API-REFERENCE/error-codes.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: REFERENCE/api/rest-api-reference.md - Archivált pillanatkép: archives/pre-consolidation/04-API-REFERENCE/error-codes.md
