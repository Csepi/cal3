---
title: "Migrációs referencia"
description: "Lépésről lépésre útmutató az áttelepítéshez a PrimeCalendar dokumentumban."
category: "Hivatkozás"
audience: "Fejlesztő"
difficulty: "Haladó"
...
# Migrációs referencia {#migration-reference}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar migrációs hivatkozásait ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a migrációs hivatkozások megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatának következetes viselkedésre van szüksége az áttelepítéshez.
...
- `external-database/QUICK_REFERENCE.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: REFERENCE/database/migration-reference.md - Archivált pillanatkép: archívum/pre-consolidation/external-database/QUICK_REFERENCE.md
