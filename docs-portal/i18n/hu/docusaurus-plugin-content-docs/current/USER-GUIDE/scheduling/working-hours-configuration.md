---
title: "Munkaidő konfigurálása"
description: "Lépésről lépésre útmutató a munkaidő-konfigurációhoz a PrimeCalendar-ban."
...
# Munkaidő konfigurálása {#working-hours-configuration}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar munkaidő-konfigurációját ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a munkaidő-beállítás megbízható elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a munkaidő beállításához.
