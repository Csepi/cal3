---
title: "Elérhetőség-ellenőrző"
description: "Lépésről lépésre útmutató az elérhetőség-ellenőrzőhöz a PrimeCalendar-ban."
...
# Elérhetőség-ellenőrző {#availability-checker}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar elérhetőség-ellenőrzőjét ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a rendelkezésre állás-ellenőrző megbízható elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége az elérhetőség-ellenőrzőhöz.
