---
title: "Pufferidő"
description: "Lépésről lépésre útmutató a pufferidőhöz a PrimeCalendar-ban."
...
# Pufferidő {#buffer-time}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar pufferidejét ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a pufferidő megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a pufferidőhöz.
