---
title: "Engedélyszintek"
description: "Lépésről lépésre útmutató a PrimeCalendar engedélyszintjéhez."
...
# Engedélyszintek {#permission-levels}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar engedélyszintjeit ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az engedélyszintek megbízható teljesítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége az engedélyszintekhez.
...
- `05-USER-GUIDES/sharing-permissions.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: USER-GUIDE/sharing-and-collaboration/permission-levels.md - Archivált pillanatkép: archives/pre-consolidation/05-USER-GUIDES/sharing-permissions.md
