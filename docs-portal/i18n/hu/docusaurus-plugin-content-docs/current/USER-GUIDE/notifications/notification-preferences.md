...
description: "Lépésről lépésre az értesítési beállításokhoz a PrimeCalendar webhelyen."
...
# Értesítési beállítások {#notification-preferences}
...
Használja ezt az útmutatót az értesítési beállítások megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
