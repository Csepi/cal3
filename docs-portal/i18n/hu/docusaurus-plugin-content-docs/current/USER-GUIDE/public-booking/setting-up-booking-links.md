---
title: "Foglalási linkek beállítása"
description: "Lépésről lépésre útmutató a foglalási linkek beállításához a PrimeCalendar-ban."
...
# Foglalási linkek beállítása {#setting-up-booking-links}

> **Gyors összefoglaló**: Ez az oldal elmagyarázza a foglalási linkek beállítását a PrimeCalendar-ban gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a foglalási linkek megbízható beállításához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes magatartásra van szüksége a foglalási linkek beállításához.
...
- `05-USER-GUIDES/public-booking-guide.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: FELHASZNÁLÓI ÚTMUTATÓ/public-booking/setting-up-booking-links.md - Archivált pillanatkép: archives/pre-consolidation/05-USER-GUIDES/public-booking-guide.md
