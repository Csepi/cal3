---
title: "Intelligens értékek"
description: "Lépésről lépésre útmutató az intelligens értékekhez a PrimeCalendar-ban."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, automation, smart, values, primecalendar]
---

# Intelligens értékek {#smart-values}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar intelligens értékeit ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az intelligens értékek megbízható kiegészítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes magatartásra van szüksége az intelligens értékek érdekében.
...
- `automation-smart-values.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: FELHASZNÁLÓI ÚTMUTATÓ/automation/smart-values.md - Archivált pillanatkép: archívum/pre-consolidation/automation-smart-values.md
