...
description: "Lépésről lépésre útmutató az erőforrások létrehozásához a PrimeCalendar-ban."
...
# Erőforrások létrehozása {#creating-resources}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar erőforrások létrehozását ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót az erőforrások létrehozásának megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége az erőforrások létrehozásához.
