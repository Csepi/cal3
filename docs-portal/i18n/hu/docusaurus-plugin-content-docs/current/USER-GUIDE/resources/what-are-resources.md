---
title: "Mik azok az erőforrások"
description: "Lépésről lépésre útmutató a PrimeCalendar erőforrásaihoz."
...
# Mik azok az erőforrások {#what-are-resources}

> **Gyors összefoglaló**: Ez az oldal gyakorlati lépések és hibaelhárítási útmutatások segítségével ismerteti, hogy melyek a PrimeCalendar erőforrásai.
...
Használja ezt az útmutatót a források megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: csapatának következetes viselkedésre van szüksége az erőforrások tekintetében.
