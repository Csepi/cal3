...
description: "Lépésről lépésre a zoom-integrációhoz a PrimeCalendar-ban."
...
# Zoom integráció {#zoom-integration}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar nagyítási integrációját ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a zoomintegráció megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a zoom-integrációhoz.
