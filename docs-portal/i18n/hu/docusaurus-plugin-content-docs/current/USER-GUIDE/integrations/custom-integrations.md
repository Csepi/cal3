...
- `03-FEATURES/sync-integrations.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: FELHASZNÁLÓI ÚTMUTATÓ/integrations/custom-integrations.md - Archivált pillanatkép: archives/pre-consolidation/03-FEATURES/sync-integrations.md
