...
description: "Napi PrimeCal munkafolyamatok a profilbeállításokhoz, naptárakhoz, feladatokhoz, automatizáláshoz, külső szinkronizáláshoz, AI-ügynökökhöz és személyes naplókhoz."
...
<div class="pc-guide-hero">
  ...
  <p class="pc-guide-hero__lead">Ez a szakasz a regisztráció utáni szokásos PrimeCal utat követi: profilbeállítás, naptári munka, eseménykészítés, feladatok, automatizálás, külső szinkronizálás, mesterséges intelligencia-ügynökök és személyes naplók.</p>
  <div class="pc-guide-chip-row">
    <span class="pc-guide-chip">Csak felhasználónak szánt</span>
    <span class="pc-guide-chip">Jelenlegi felhasználói felület címkéi</span>
    <span class="pc-guide-chip">Valódi képernyőképek</span>
    <span class="pc-guide-chip">Fejlesztői linkek elválasztva</span>
  </div>
</div>
...
A fő naptár és feladatterületek a felső munkaterületen láthatók. A fejlettebb eszközöket a `More` tartalmazza.

![PrimeCal További menü, amely a speciális funkciókhoz való hozzáférést mutatja](../assets/user-guide/navigation/more-menu-feature-navigation.png)

## Ajánlott olvasási sorrend {#recommended-reading-order}

1. [Profiloldal](./profile/profile-page.md)
2. [Naptár munkaterület](./calendars/calendar-workspace.md)
3. [Események létrehozása](./basics/creating-events.md)
4. [Naptárnézetek](./basics/calendar-views.md)
5. [Tasks munkaterület](./tasks/tasks-workspace.md)
6. [Bevezetés az automatizálásba](./automation/introduction-to-automation.md)
7. [Külső szinkronizálás](./integrations/external-sync.md)
8. [Az ügynök konfigurációja](./agents/agent-configuration.md)
9. [Személyes naplók](./privacy/personal-logs.md)

## Fejlesztői részletek {#developer-details}

A használati útmutató szándékosan termékközpontú marad. Ha végpontszerződésekre, korlátozásokra vagy példákra van szüksége, folytassa a [Fejlesztői dokumentációval](../DEVELOPER-GUIDE/index.md).
