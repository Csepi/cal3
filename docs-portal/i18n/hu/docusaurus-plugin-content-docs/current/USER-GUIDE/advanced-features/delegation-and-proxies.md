---
title: "Delegáció és Meghatalmazottak"
description: "Lépésről lépésre szóló útmutató a delegáláshoz és a proxykhoz a PrimeCalendar-ban."
...
# Delegáció és Meghatalmazottak {#delegation-and-proxies}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar delegálását és a proxykat ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a delegálás és a proxy megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a delegálás és a meghatalmazott személyek esetében.
...
- `03-FEATURES/smart-home.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: FELHASZNÁLÓI ÚTMUTATÓ/advanced-features/delelegation-and-proxyes.md - Archivált pillanatkép: archívum/pre-consolidation/03-FEATURES/smart-home.md
- `05-USER-GUIDES/smart-home-guide.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: FELHASZNÁLÓI ÚTMUTATÓ/advanced-features/delegation-and-proxyes.md - Archivált pillanatkép: archives/pre-consolidation/05-USER-GUIDES/smart-home-guide.md
