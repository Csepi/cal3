---
title: "Dátum és idő formátumai"
description: "Lépésről lépésre útmutatás a dátum-idő formátumokhoz a PrimeCalendar-ban."
...
# Dátum és idő formátumai {#date-time-formats}

> **Gyors összefoglaló**: Ez az oldal gyakorlati lépésekkel és hibaelhárítási útmutatásokkal ismerteti a dátum és idő formátumait a PrimeCalendar nyelven.
...
Használja ezt az útmutatót a dátum és idő formátumok megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a dátum és idő formátumaihoz.
