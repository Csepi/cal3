---
title: "Mobil widgetek"
description: "Lépésről lépésre útmutató mobil widgetekhez itt: PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, mobile, app, widgets, primecalendar]
---

# Mobil widgetek {#mobile-widgets}

> **Gyors összefoglaló**: Ez az oldal gyakorlati lépésekkel és hibaelhárítási útmutatásokkal ismerteti a PrimeCalendar mobil moduljait.
...
Használja ezt az útmutatót a mobil widgetek megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a mobil kütyükkel kapcsolatban.
