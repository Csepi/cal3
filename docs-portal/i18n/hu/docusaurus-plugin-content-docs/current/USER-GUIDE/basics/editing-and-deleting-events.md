---
title: "Események szerkesztése és törlése"
description: "Lépésről lépésre szóló útmutató az események szerkesztéséhez és törléséhez a PrimeCalendar-ban."
...
# Események szerkesztése és törlése {#editing-and-deleting-events}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar eseményeinek szerkesztését és törlését ismerteti gyakorlati lépések és hibaelhárítási útmutatók segítségével.
...
Használja ezt az útmutatót az események szerkesztésének és törlésének megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége az események szerkesztéséhez és törléséhez.
