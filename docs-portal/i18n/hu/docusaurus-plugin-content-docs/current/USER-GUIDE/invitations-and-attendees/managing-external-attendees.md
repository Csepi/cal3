---
title: "Külső résztvevők kezelése"
description: "Lépésről lépésre útmutató a külső résztvevők kezeléséhez a PrimeCalendar-ban."
...
# Külső résztvevők kezelése {#managing-external-attendees}

> **Gyors összefoglaló**: Ez az oldal a külső résztvevők kezelését ismerteti a PrimeCalendar programban gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a külső résztvevők megbízható kezelésének elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a külső résztvevők kezeléséhez.
