---
title: "Több naptár kezelése"
description: "Lépésről lépésre szóló útmutató több naptár kezeléséhez a PrimeCalendar alkalmazásban."
...
# Több naptár kezelése {#managing-multiple-calendars}

> **Gyors összefoglaló**: Ez az oldal több naptár kezelését ismerteti a PrimeCalendar alkalmazásban gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Ezzel az útmutatóval több naptárat is megbízhatóan kezelhet. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes magatartásra van szüksége több naptár kezeléséhez.
...
- `03-FEATURES/calendar-management.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: FELHASZNÁLÓI ÚTMUTATÓ/calendars/managing-multiple-calendars.md - Archivált pillanatkép: archives/pre-consolidation/03-FEATURES/calendar-management.md
