---
title: "Beépülő modulok létrehozása"
description: "Lépésről lépésre útmutató bővítmények létrehozásához a PrimeCalendar alkalmazásban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, extending, primecalendar, creating, plugins]
---

# Beépülő modulok létrehozása {#creating-plugins}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar bővítményeinek létrehozását ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a bővítmények létrehozásának megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a bővítmények létrehozásához.
