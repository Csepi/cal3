...
description: "Lépésről lépésre az egyéni integrációkhoz a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Egyedi integrációk {#custom-integrations}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar egyéni integrációit ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az egyéni integrációk megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége az egyéni integrációkhoz.
...
- `02-ARCHITECTURE/integrations.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/extending-primecalendar/custom-integrations.md - Archivált pillanatkép: archívum/pre-consolidation/02-ARCHITECTURE/integrations.md
- `RESERVATION_CALENDARS_IMPLEMENTATION.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/extending-primecalendar/custom-integrations.md - Archivált pillanatkép: archívum/pre-consolidation/RESERVATION_CALENDARS_IMPLEMENTATION.md
