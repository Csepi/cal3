...
description: "Lépésről lépésre útmutató a mobil teszteléshez a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Mobil tesztelés {#mobile-testing}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar mobil tesztelését ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a mobilteszt megbízható elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a mobiltesztekhez.
