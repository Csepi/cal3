---
title: "Natív beépülő modulok"
description: "Lépésről lépésre a natív beépülő modulokhoz a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, mobile, development, native, plugins, primecalendar]
---

# Natív beépülő modulok {#native-plugins}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar natív bővítményeit ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a natív bővítmények megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a natív beépülő modulokhoz.
