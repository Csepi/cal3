---
title: "Útválasztás"
description: "Lépésről lépésre az útválasztáshoz a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar-ban való útválasztást ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót az útválasztás megbízható elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége az útválasztáshoz.
