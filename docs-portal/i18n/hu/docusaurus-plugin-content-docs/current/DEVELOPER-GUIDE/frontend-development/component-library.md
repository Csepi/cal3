---
title: "Összetevők könyvtára"
description: "Lépésről lépésre útmutató a PrimeCalendar összetevő könyvtárához."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Összetevők könyvtára {#component-library}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar komponenskönyvtárát ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a komponenskönyvtár megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége az összetevőkönyvtárhoz.
...
- `UI_IMPROVEMENTS_IMPLEMENTATION_GUIDE.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/frontend-development/component-library.md - Archivált pillanatkép: archives/pre-consolidation/UI_IMPROVEMENTS_IMPLEMENTATION_GUIDE.md
