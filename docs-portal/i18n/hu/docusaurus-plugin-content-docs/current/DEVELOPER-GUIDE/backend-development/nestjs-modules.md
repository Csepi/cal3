---
title: "Nestjs modulok"
description: "Lépésről lépésre a nestjs modulokhoz a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Nestjs modulok {#nestjs-modules}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar nestjs moduljait ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a nestjs modulok megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a nestjs-modulokhoz.
...
- `06-DEVELOPER-GUIDES/adding-endpoints.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/backend-development/nestjs-modules.md - Archivált pillanatkép: archives/pre-consolidation/06-DEVELOPER-GUIDES/adding-endpoints.md
