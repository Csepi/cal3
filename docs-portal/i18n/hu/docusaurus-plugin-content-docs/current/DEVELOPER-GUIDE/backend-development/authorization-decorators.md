---
title: "Engedélyező dekorátorok"
description: "Lépésről lépésre útmutató a jogosultság díszítők számára a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Engedélyező dekorátorok {#authorization-decorators}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar engedélyezési dekorátorait ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót az engedélyezési dekorátorok megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes magatartásra van szüksége az engedélyezési dekorátorokkal szemben.
