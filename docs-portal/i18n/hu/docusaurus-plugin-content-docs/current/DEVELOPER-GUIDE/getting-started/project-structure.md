---
title: "Projekt felépítése"
description: "Lépésről lépésre útmutató a projekt szerkezetéhez a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, getting, started, project, structure, primecalendar]
---

# Projekt felépítése {#project-structure}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar projekt felépítését ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatóval.
...
Használja ezt az útmutatót a projektstruktúra megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a projekt felépítéséhez.
...
- `06-DEVELOPER-GUIDES/code-organization.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/getting-started/project-structure.md - Archivált pillanatkép: archives/pre-consolidation/06-DEVELOPER-GUIDES/code-organization.md
