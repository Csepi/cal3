---
title: "Helyi futás"
description: "Lépésről lépésre útmutató a PrimeCalendar helyi futtatásához."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Helyi futás {#running-locally}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar helyi futtatását ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a megbízható helyi futtatáshoz. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatának következetes viselkedésre van szüksége a helyi működéshez.
