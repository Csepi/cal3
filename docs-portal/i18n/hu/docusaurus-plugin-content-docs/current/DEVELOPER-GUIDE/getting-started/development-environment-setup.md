---
title: "Fejlesztői környezet beállítása"
description: "Lépésről lépésre útmutató a fejlesztői környezet beállításához a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Fejlesztői környezet beállítása {#development-environment-setup}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar fejlesztői környezet beállítását ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatóval.
...
Használja ezt az útmutatót a fejlesztői környezet beállításának megbízható elvégzéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a fejlesztői környezet beállításához.
...
- `06-DEVELOPER-GUIDES/local-setup.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/getting-started/development-environment-setup.md - Archivált pillanatkép: archives/pre-consolidation/06-DEVELOPER-GUIDES/local-setup.md
