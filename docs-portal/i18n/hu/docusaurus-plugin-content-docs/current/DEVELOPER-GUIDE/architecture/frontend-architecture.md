...
description: "Lépésről lépésre útmutató a frontend architektúrához a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Haladó"
...
# Frontend architektúra {#frontend-architecture}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar frontend architektúráját ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a frontend architektúra megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a frontend architektúrához.
...
- `02-ARCHITECTURE/frontend-structure.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/architecture/frontend-architecture.md - Archivált pillanatkép: archives/pre-consolidation/02-ARCHITECTURE/frontend-structure.md
