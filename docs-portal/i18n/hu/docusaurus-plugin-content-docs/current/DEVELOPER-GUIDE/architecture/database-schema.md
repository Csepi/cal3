...
description: "Részletes útmutatás az adatbázissémához itt: PrimeCalendar."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Haladó"
...
> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar adatbázissémáját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatóval.
...
Használja ezt az útmutatót az adatbázisséma megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak konzisztens viselkedésre van szüksége az adatbázissémához.
...
- `02-ARCHITECTURE/database-schema.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/architecture/database-schema.md - Archivált pillanatkép: archives/pre-consolidation/02-ARCHITECTURE/database-schema.md
