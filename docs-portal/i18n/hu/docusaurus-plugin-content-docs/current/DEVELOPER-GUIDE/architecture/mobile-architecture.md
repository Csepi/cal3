---
title: "Mobil architektúra"
description: "Lépésről lépésre a mobil architektúrához a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Haladó"
...
# Mobil architektúra {#mobile-architecture}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar mobil architektúráját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a mobil architektúra megbízható befejezéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a mobil architektúrához.
