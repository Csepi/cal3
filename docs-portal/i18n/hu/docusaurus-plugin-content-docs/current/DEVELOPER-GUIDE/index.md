...
<div class="pc-guide-grid">
  <article class="pc-guide-card pc-guide-card--accent">
    ...
    <h3><a href="/DEVELOPER-GUIDE/api-reference/api-overview">API áttekintése</a></h3>
  ...
  <article class="pc-guide-card">
    ...
    <h3><a href="/DEVELOPER-GUIDE/api-reference/user-api">Felhasználói API</a></h3>
  ...
  <article class="pc-guide-card pc-guide-card--signal">
    ...
    <h3><a href="/DEVELOPER-GUIDE/api-reference/automation-api">Automatizálási API</a></h3>
...
<div class="pc-guide-grid">
  <article class="pc-guide-card">
    ...
    <h3><a href="/DEVELOPER-GUIDE/api-reference/calendar-api">Naptár</a>, <a href="/DEVELOPER-GUIDE/api-reference/event-api">Események</a>, <a href="/DEVELOPER-GUIDE/api-reference/tasks-api">Feladatok</a></h3>
  ...
  <article class="pc-guide-card">
    ...
    <h3><a href="/DEVELOPER-GUIDE/api-reference/sync-api">Külső szinkronizálás</a></h3>
  ...
  <article class="pc-guide-card">
    ...
    <h3><a href="/DEVELOPER-GUIDE/api-reference/notifications-api">Értesítések</a>, <a href="/DEVELOPER-GUIDE/api-reference/personal-logs-api">Személyes naplók</a>, <a href="/DEVELOPER-GUIDE/api-reference/compliance-api">Megfelelőség</a></h3>
  ...
  <article class="pc-guide-card">
    ...
    <h3><a href="/DEVELOPER-GUIDE/api-reference/organization-api">Szervezetek</a>, <a href="/DEVELOPER-GUIDE/api-reference/resource-api">Források</a>, <a href="/DEVELOPER-GUIDE/api-reference/booking-api">Foglalás</a></h3>
