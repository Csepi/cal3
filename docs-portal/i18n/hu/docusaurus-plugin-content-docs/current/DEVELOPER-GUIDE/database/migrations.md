---
title: "Migrációk"
description: "Lépésről lépésre szóló útmutató a PrimeCalendar áttelepítéséhez."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Haladó"
...
> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar áttelepítését ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatóval.
...
Használja ezt az útmutatót az áttelepítések megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatának következetes viselkedésre van szüksége a migrációhoz.
...
- `06-DEVELOPER-GUIDES/database-migrations.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/database/migrations.md - Archivált pillanatkép: archives/pre-consolidation/06-DEVELOPER-GUIDES/database-migrations.md
