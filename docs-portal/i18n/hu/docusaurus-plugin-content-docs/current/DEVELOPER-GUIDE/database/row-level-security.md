---
title: "Sor szintű biztonság"
description: "Lépésről lépésre a sor szintű biztonsághoz a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Haladó"
...
# Sor szintű biztonság {#row-level-security}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar sor szintű biztonságát ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a sorszintű biztonság megbízható teljesítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a sorszintű biztonság érdekében.
