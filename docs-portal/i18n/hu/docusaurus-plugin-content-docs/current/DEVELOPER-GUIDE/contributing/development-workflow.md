---
title: "Fejlesztési munkafolyamat"
description: "Lépésről lépésre útmutató a fejlesztési munkafolyamathoz a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, contributing, development, workflow, primecalendar]
---

# Fejlesztési munkafolyamat {#development-workflow}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar fejlesztési munkafolyamatait ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a fejlesztési munkafolyamat megbízható végrehajtásához. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: A csapatnak következetes viselkedésre van szüksége a fejlesztési munkafolyamathoz.
...
- `security/repo-hygiene.md`: Ez az oldal átkerült a konszolidált szerkezetbe. - Kanonikus oldal: DEVELOPER-GUIDE/contributing/development-workflow.md - Archivált pillanatkép: archívum/pre-consolidation/security/repo-hygiene.md
