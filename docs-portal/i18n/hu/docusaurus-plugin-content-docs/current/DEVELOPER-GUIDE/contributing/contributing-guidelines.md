...
description: "Lépésről lépésre útmutatás a hozzájárulási irányelvekhez a PrimeCalendar dokumentumban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, contributing, guidelines, primecalendar]
---

# Hozzájárulási irányelvek {#contributing-guidelines}

> **Gyors összefoglaló**: Ez az oldal elmagyarázza a PrimeCalendar hozzájárulási irányelveit gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a hozzájárulási irányelvek megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes magatartásra van szüksége az irányelvek kidolgozásához.
