---
title: "Problémajelentés"
description: "Lépésről lépésre útmutató a hibajelentéshez a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Problémajelentés {#issue-reporting}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar hibabejelentését ismerteti gyakorlati lépések és hibaelhárítási útmutatások segítségével.
...
Használja ezt az útmutatót a hibajelentés megbízható elkészítéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a hibajelentéshez.
