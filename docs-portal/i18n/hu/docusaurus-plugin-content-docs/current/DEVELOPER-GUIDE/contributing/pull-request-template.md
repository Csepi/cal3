---
title: "Húzza le a kérési sablont"
description: "Lépésről lépésre útmutatás a lekérési kérelem sablonhoz a PrimeCalendar-ban."
category: "Fejlesztő"
audience: "Fejlesztő"
difficulty: "Közepes"
...
# Húzza le a kérési sablont {#pull-request-template}

> **Gyors összefoglaló**: Ez az oldal a PrimeCalendar lekérési kéréssablonját ismerteti gyakorlati lépésekkel és hibaelhárítási útmutatásokkal.
...
Használja ezt az útmutatót a lekérési kérelem sablon megbízható kitöltéséhez. Minden lépés után erősítse meg a várt eredményeket, mielőtt az opcionális speciális beállításokra váltana.
...
**Forgatókönyv**: Csapatának következetes viselkedésre van szüksége a lekérési kéréssablonhoz.
