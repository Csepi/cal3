---
title: "Migrationsreferenz"
description: "Schritt-für-Schritt-Anleitung zur Migrationsreferenz in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, database, migration, primecalendar]
---

# Migrationsreferenz {#migration-reference}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Migrationsreferenz in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die Migrationsreferenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Migrationsreferenz.
...
- `external-database/QUICK_REFERENCE.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: REFERENCE/database/migration-reference.md – Archivierter Snapshot: archives/pre-consolidation/external-database/QUICK_REFERENCE.md
