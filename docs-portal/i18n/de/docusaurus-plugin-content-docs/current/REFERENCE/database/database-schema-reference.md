---
title: "Referenz zum Datenbankschema"
description: "Schritt-für-Schritt-Anleitung für die Datenbankschemareferenz in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, database, schema, primecalendar]
---

# Referenz zum Datenbankschema {#database-schema-reference}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Datenbankschemareferenz in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie dieses Handbuch, um die Datenbankschemareferenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Datenbankschemareferenz.
