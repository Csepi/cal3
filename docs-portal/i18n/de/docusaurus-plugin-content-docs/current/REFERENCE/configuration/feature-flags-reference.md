---
title: "Referenz zu Funktionsflags"
description: "Schritt-für-Schritt-Anleitung für die Feature-Flags-Referenz in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
# Referenz zu Funktionsflags {#feature-flags-reference}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Referenz zu Funktionsflags in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Feature-Flags-Referenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Referenz auf Feature-Flags.
