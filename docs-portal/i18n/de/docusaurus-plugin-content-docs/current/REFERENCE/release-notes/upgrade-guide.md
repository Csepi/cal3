...
description: "Schritt-für-Schritt-Anleitung für die Upgrade-Anleitung in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, release, notes, upgrade, primecalendar]
---

# Upgrade-Anleitung {#upgrade-guide}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Upgrade-Anleitung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Upgrade-Anleitung zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für den Upgrade-Leitfaden.
