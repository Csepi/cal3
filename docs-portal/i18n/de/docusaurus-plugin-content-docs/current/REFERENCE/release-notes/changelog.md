...
description: "Schritt-für-Schritt-Anleitung für Changelog in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, release, notes, changelog, primecalendar]
---

# Änderungsprotokoll {#changelog}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Änderungsprotokoll in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um das Änderungsprotokoll zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für das Änderungsprotokoll.
...
- `releases/tasks-mcp-rollout.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: REFERENCE/release-notes/changelog.md – Archivierter Snapshot: archives/pre-consolidation/releases/tasks-mcp-rollout.md
