---
title: "Graphql API Referenz"
description: "Schritt-für-Schritt-Anleitung für die Graphql-API-Referenz in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, api, graphql, primecalendar]
---

# Graphql API Referenz {#graphql-api-reference}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Graphql-API-Referenz in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die GraphQL-API-Referenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Graphql-API-Referenz.
