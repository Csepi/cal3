...
description: "Schritt-für-Schritt-Anleitung für die Rest-API-Referenz in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
> **Kurze Zusammenfassung**: Auf dieser Seite wird die Rest-API-Referenz in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Rest-API-Referenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Rest-API-Referenz.
...
- `04-API-REFERENCE/error-codes.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: REFERENCE/api/rest-api-reference.md – Archivierter Snapshot: archives/pre-consolidation/04-API-REFERENCE/error-codes.md
