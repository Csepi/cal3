---
title: "Bedingungsreferenz"
description: "Schritt-für-Schritt-Anleitung für die Bedingungsreferenz in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, automation, condition, primecalendar]
---

# Bedingungsreferenz {#condition-reference}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Bedingungsreferenz in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Zustandsreferenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für die Bedingungsreferenz.
