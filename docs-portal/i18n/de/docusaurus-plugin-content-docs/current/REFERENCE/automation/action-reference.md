---
title: "Aktionsreferenz"
description: "Schritt-für-Schritt-Anleitung zur Aktionsreferenz in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, automation, action, primecalendar]
---

# Aktionsreferenz {#action-reference}

> **Kurze Zusammenfassung**: Auf dieser Seite werden die Aktionsreferenzen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Aktionsreferenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten als Referenz für Aktionen.
