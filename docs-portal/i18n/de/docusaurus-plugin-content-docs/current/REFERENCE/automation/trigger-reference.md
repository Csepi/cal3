---
title: "Trigger-Referenz"
description: "Schritt-für-Schritt-Anleitung zur Trigger-Referenz in PrimeCalendar."
category: "Referenz"
audience: "Entwickler"
...
# Trigger-Referenz {#trigger-reference}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Triggerreferenz in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Triggerreferenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten als Auslöserreferenz.
