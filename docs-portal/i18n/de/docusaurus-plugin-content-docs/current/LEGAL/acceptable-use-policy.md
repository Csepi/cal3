...
description: "Schritt-für-Schritt-Anleitung für akzeptable Nutzungsrichtlinien in PrimeCalendar."
category: "Legal"
...
# Richtlinien zur akzeptablen Nutzung {#acceptable-use-policy}

> **Kurze Zusammenfassung**: Auf dieser Seite werden die Richtlinien zur akzeptablen Nutzung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die Richtlinien zur akzeptablen Nutzung zuverlässig umzusetzen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für akzeptable Nutzungsrichtlinien.
