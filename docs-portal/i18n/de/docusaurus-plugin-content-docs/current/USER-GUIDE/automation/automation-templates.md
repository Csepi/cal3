...
description: "Schritt-für-Schritt-Anleitung für Automatisierungsvorlagen in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, automation, templates, primecalendar]
---

# Automatisierungsvorlagen {#automation-templates}

> **Kurze Zusammenfassung**: Auf dieser Seite werden Automatisierungsvorlagen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um Automatisierungsvorlagen zuverlässig zu vervollständigen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Automatisierungsvorlagen.
