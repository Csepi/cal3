...
description: "Tägliche PrimeCal-Workflows für Profileinstellungen, Kalender, Aufgaben, Automatisierung, externe Synchronisierung, KI-Agenten und persönliche Protokolle."
...
<div class="pc-guide-hero">
  ...
  <p class="pc-guide-hero__lead">Dieser Abschnitt folgt dem normalen PrimeCal Weg nach der Anmeldung: Profileinrichtung, Kalenderarbeit, Ereigniserstellung, Aufgaben, Automatisierung, externe Synchronisierung, KI-Agenten und persönliche Protokolle.</p>
  <div class="pc-guide-chip-row">
    <span class="pc-guide-chip">Nur für den Benutzer</span>
    <span class="pc-guide-chip">Aktuelle UI-Beschriftungen</span>
    <span class="pc-guide-chip">Echte Screenshots</span>
    <span class="pc-guide-chip">Entwickler-Links getrennt</span>
  </div>
</div>

## Wohin als nächstes gehen? {#where-to-go-next}
...
Die Hauptkalender- und Aufgabenbereiche sind im oberen Arbeitsbereich sichtbar. Fortgeschrittenere Tools sind unter `More` gesammelt.

![PrimeCal Weiteres Menü mit Zugriff auf erweiterte Funktionen](../assets/user-guide/navigation/more-menu-feature-navigation.png)

## Empfohlene Lesereihenfolge {#recommended-reading-order}

1. [Profilseite](./profile/profile-page.md)
2. [Kalenderarbeitsbereich](./calendars/calendar-workspace.md)
3. [Ereignisse erstellen](./basics/creating-events.md)
4. [Kalenderansichten](./basics/calendar-views.md)
5. [Aufgabenarbeitsbereich](./tasks/tasks-workspace.md)
6. [Einführung in die Automatisierung](./automation/introduction-to-automation.md)
7. [Externe Synchronisierung](./integrations/external-sync.md)
8. [Agent-Konfiguration](./agents/agent-configuration.md)
9. [Persönliche Protokolle](./privacy/personal-logs.md)

## Entwicklerdetails {#developer-details}

Das Benutzerhandbuch bleibt bewusst produktorientiert. Wenn Sie Endpunktverträge, Einschränkungen oder Anforderungsbeispiele benötigen, fahren Sie mit der [Entwicklerdokumentation](../DEVELOPER-GUIDE/index.md) fort.
