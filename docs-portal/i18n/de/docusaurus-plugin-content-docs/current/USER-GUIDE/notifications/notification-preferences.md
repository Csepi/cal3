...
related:
  - ../index.md
  - ../../index.md
tags: [user, notifications, notification, preferences, primecalendar]
---
...
Verwenden Sie diese Anleitung, um Benachrichtigungseinstellungen zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Benachrichtigungspräferenzen.
