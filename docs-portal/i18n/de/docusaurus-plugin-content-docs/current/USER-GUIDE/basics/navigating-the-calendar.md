---
title: "Navigieren im Kalender"
description: "Schritt-für-Schritt-Anleitung zum Navigieren im Kalender in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, basics, navigating, the, calendar, primecalendar]
---

# Navigieren im Kalender {#navigating-the-calendar}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Navigation im Kalender in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Navigation im Kalender zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten beim Navigieren im Kalender.
...
- `05-USER-GUIDES/basic-usage.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: USER-GUIDE/basics/navigating-the-calendar.md – Archivierter Schnappschuss: archives/pre-consolidation/05-USER-GUIDES/basic-usage.md
