---
title: "Bearbeiten und Löschen von Ereignissen"
description: "Schritt-für-Schritt-Anleitung zum Bearbeiten und Löschen von Ereignissen in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, basics, editing, and, deleting, events, primecalendar]
---

# Bearbeiten und Löschen von Ereignissen {#editing-and-deleting-events}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Bearbeiten und Löschen von Ereignissen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um das Bearbeiten und Löschen von Ereignissen zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten beim Bearbeiten und Löschen von Ereignissen.
