...
description: "Schritt-für-Schritt-Anleitung für die Verfügbarkeitsprüfung in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, scheduling, availability, checker, primecalendar]
---

# Verfügbarkeitsprüfung {#availability-checker}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Verfügbarkeitsprüfung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Verfügbarkeitsprüfung zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Verfügbarkeitsprüfung.
