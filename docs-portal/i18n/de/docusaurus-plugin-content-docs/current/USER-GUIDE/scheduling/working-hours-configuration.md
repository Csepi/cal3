---
title: "Arbeitszeitkonfiguration"
description: "Schritt-für-Schritt-Anleitung zur Arbeitszeitkonfiguration in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, scheduling, working, hours, configuration, primecalendar]
---

# Arbeitszeitkonfiguration {#working-hours-configuration}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Arbeitszeitkonfiguration in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Nutzen Sie diese Anleitung, um die Arbeitszeitkonfiguration zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Arbeitszeitkonfiguration.
