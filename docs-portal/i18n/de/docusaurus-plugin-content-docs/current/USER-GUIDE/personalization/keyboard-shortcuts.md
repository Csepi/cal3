...
description: "Schritt-für-Schritt-Anleitung für Tastaturkürzel in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, personalization, keyboard, shortcuts, primecalendar]
---

# Tastaturkürzel {#keyboard-shortcuts}

> **Kurze Zusammenfassung**: Auf dieser Seite werden Tastaturkürzel in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um Tastaturkürzel zuverlässig auszuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Tastaturkürzel.
