...
description: "Schritt-für-Schritt-Anleitung zum Erstellen von Ressourcen in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, resources, creating, primecalendar]
---

# Ressourcen erstellen {#creating-resources}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Erstellen von Ressourcen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Erstellung von Ressourcen zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten beim Erstellen von Ressourcen.
