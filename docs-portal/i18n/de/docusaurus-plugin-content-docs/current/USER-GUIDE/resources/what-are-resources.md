...
description: "Schritt-für-Schritt-Anleitung für die Ressourcen in PrimeCalendar."
...
# Was sind Ressourcen? {#what-are-resources}

> **Kurze Zusammenfassung**: Auf dieser Seite werden die Ressourcen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die Ressourcen zuverlässig zu vervollständigen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Ressourcen.
