...
description: "Schritt-für-Schritt-Anleitung zur Buchung von Ressourcen in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, resources, booking, primecalendar]
---

# Buchungsressourcen {#booking-resources}

> **Kurze Zusammenfassung**: Auf dieser Seite werden Buchungsressourcen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Nutzen Sie diesen Leitfaden, um Buchungsressourcen zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten bei der Buchung von Ressourcen.
...
- `03-FEATURES/reservations.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: USER-GUIDE/resources/booking-resources.md – Archivierter Schnappschuss: archives/pre-consolidation/03-FEATURES/reservations.md
- `05-USER-GUIDES/reservations-guide.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: USER-GUIDE/resources/booking-resources.md – Archivierter Schnappschuss: archives/pre-consolidation/05-USER-GUIDES/reservations-guide.md
