...
description: "Schritt-für-Schritt-Anleitung zum Löschen von Kalendern in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, calendars, deleting, primecalendar]
---

# Kalender löschen {#deleting-calendars}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Löschen von Kalendern in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um das Löschen von Kalendern zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten beim Löschen von Kalendern.
