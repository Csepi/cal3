---
title: "iCalendar-Export-Import"
description: "Schritt-für-Schritt-Anleitung für den Calendar-Export-Import in PrimeCalendar."
...
# iCalendar-Export-Import {#icalendar-export-import}

> **Kurze Zusammenfassung**: Auf dieser Seite wird der Import von Calendar-Exporten in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um den Kalender-Export-Import zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für den Export und Import von Kalendern.
...
- `08-MIGRATION/data-import.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: USER-GUIDE/advanced-features/icalendar-export-import.md – Archivierter Snapshot: archives/pre-consolidation/08-MIGRATION/data-import.md
