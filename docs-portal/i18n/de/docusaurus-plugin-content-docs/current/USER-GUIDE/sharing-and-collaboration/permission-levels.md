...
description: "Schritt-für-Schritt-Anleitung für Berechtigungsstufen in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, sharing, and, collaboration, permission, levels, primecalendar]
---

# Berechtigungsstufen {#permission-levels}

> **Kurze Zusammenfassung**: Auf dieser Seite werden die Berechtigungsstufen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um Berechtigungsstufen zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Berechtigungsstufen.
...
- `05-USER-GUIDES/sharing-permissions.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: USER-GUIDE/sharing-and-collaboration/permission-levels.md – Archivierter Schnappschuss: archives/pre-consolidation/05-USER-GUIDES/sharing-permissions.md
