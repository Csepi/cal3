---
title: "Buchungslinks einrichten"
description: "Schritt-für-Schritt-Anleitung zum Einrichten von Buchungslinks in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, public, booking, setting, up, links, primecalendar]
---

# Buchungslinks einrichten {#setting-up-booking-links}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Einrichten von Buchungslinks in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Einrichtung von Buchungslinks zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten beim Einrichten von Buchungslinks.
...
- `05-USER-GUIDES/public-booking-guide.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: USER-GUIDE/public-booking/setting-up-booking-links.md – Archivierter Schnappschuss: archives/pre-consolidation/05-USER-GUIDES/public-booking-guide.md
