...
description: "Schritt-für-Schritt-Anleitung zur Verwaltung von Buchungen in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, public, booking, managing, bookings, primecalendar]
---

# Buchungen verwalten {#managing-bookings}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Verwaltung von Buchungen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Nutzen Sie diesen Leitfaden, um die Buchungsverwaltung zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten bei der Verwaltung von Buchungen.
...
- `03-FEATURES/public-booking.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: USER-GUIDE/public-booking/managing-bookings.md – Archivierter Schnappschuss: archives/pre-consolidation/03-FEATURES/public-booking.md
