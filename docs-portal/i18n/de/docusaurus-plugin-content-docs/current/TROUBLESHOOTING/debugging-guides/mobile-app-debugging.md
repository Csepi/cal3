---
title: "Debuggen mobiler Apps"
description: "Schritt-für-Schritt-Anleitung für das Debuggen mobiler Apps in PrimeCalendar."
...
# Debuggen mobiler Apps {#mobile-app-debugging}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Debuggen mobiler Apps in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um das Debuggen mobiler Apps zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für das Debuggen mobiler Apps.
