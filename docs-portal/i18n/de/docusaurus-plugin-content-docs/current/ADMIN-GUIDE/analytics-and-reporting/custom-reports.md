...
description: "Schritt-für-Schritt-Anleitung für benutzerdefinierte Berichte in PrimeCalendar."
category: "Admin"
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, analytics, and, reporting, custom, reports, primecalendar]
---

# Benutzerdefinierte Berichte {#custom-reports}

> **Kurze Zusammenfassung**: Auf dieser Seite werden benutzerdefinierte Berichte in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um benutzerdefinierte Berichte zuverlässig zu erstellen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für benutzerdefinierte Berichte.
