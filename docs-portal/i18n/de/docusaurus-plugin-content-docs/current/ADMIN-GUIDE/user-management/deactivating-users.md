...
description: "Schritt-für-Schritt-Anleitung zum Deaktivieren von Benutzern in PrimeCalendar."
category: "Admin"
...
# Benutzer deaktivieren {#deactivating-users}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Deaktivierung von Benutzern in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Deaktivierung von Benutzern zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten beim Deaktivieren von Benutzern.
