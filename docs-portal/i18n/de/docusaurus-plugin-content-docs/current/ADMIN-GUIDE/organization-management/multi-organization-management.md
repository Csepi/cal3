---
title: "Multi-Organisationsmanagement"
description: "Schritt-für-Schritt-Anleitung für die Verwaltung mehrerer Organisationen in PrimeCalendar."
category: "Admin"
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, organization, management, multi, primecalendar]
---

# Multi-Organisationsmanagement {#multi-organization-management}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Verwaltung mehrerer Organisationen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die Verwaltung mehrerer Organisationen zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für die Verwaltung mehrerer Organisationen.
...
- `03-FEATURES/multi-tenancy.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: ADMIN-GUIDE/organization-management/multi-organization-management.md – Archivierter Snapshot: archives/pre-consolidation/03-FEATURES/multi-tenancy.md
