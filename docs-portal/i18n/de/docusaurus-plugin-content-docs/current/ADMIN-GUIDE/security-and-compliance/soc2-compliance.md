---
title: "SOC2-Konformität"
description: "Schritt-für-Schritt-Anleitung zur SOC2-Konformität in PrimeCalendar."
category: "Admin"
...
# SOC2-Konformität {#soc2-compliance}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die SOC2-Konformität in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die SOC2-Konformität zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für die SOC2-Compliance.
...
- `security/asvs-matrix.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: ADMIN-GUIDE/security-and-compliance/soc2-compliance.md – Archivierter Snapshot: archives/pre-consolidation/security/asvs-matrix.md
