...
description: "Schritt-für-Schritt-Anleitung zur Einhaltung der DSGVO in PrimeCalendar."
category: "Admin"
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, security, and, compliance, gdpr, primecalendar]
---

# DSGVO-Konformität {#gdpr-compliance}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Einhaltung der DSGVO in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Nutzen Sie diesen Leitfaden, um die DSGVO-Compliance zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten zur Einhaltung der DSGVO.
...
- `compliance/GDPR_MODULE.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: ADMIN-GUIDE/security-and-compliance/gdpr-compliance.md – Archivierter Snapshot: archives/pre-consolidation/compliance/GDPR_MODULE.md
