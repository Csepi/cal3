...
description: "Schritt-für-Schritt-Anleitung für die Audit-Protokollierung in PrimeCalendar."
category: "Admin"
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, security, and, compliance, audit, logging, primecalendar]
---

# Audit-Protokollierung {#audit-logging}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Überwachungsprotokollierung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Audit-Protokollierung zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Audit-Protokollierung.
...
- `compliance/CONTROLS_EVIDENCE.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: ADMIN-GUIDE/security-and-compliance/audit-logging.md – Archivierter Snapshot: archives/pre-consolidation/compliance/CONTROLS_EVIDENCE.md
