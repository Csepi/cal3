...
description: "Schritt-für-Schritt-Anleitung zum Erstellen von Gruppen in PrimeCalendar."
category: "Admin"
...
# Gruppen erstellen {#creating-groups}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Erstellen von Gruppen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Erstellung von Gruppen zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt einheitliches Verhalten für die Gruppenerstellung.
