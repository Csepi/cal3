...
description: "Schritt-für-Schritt-Anleitung für Gruppenberechtigungen in PrimeCalendar."
category: "Admin"
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, group, and, team, management, permissions, primecalendar]
---

# Gruppenberechtigungen {#group-permissions}

> **Kurze Zusammenfassung**: Auf dieser Seite werden Gruppenberechtigungen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um Gruppenberechtigungen zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Gruppenberechtigungen.
