...
description: "Schritt-für-Schritt-Anleitung zum Verwalten von Gruppenmitgliedern in PrimeCalendar."
category: "Admin"
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, group, and, team, management, managing, members, primecalendar]
---

# Gruppenmitglieder verwalten {#managing-group-members}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Verwaltung von Gruppenmitgliedern in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Verwaltung von Gruppenmitgliedern zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Verwaltung von Gruppenmitgliedern.
