...
description: "Schritt-für-Schritt-Anleitung zur Nutzungsverfolgung in PrimeCalendar."
category: "Admin"
...
# Nutzungsverfolgung {#usage-tracking}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Nutzungsverfolgung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die Nutzungsverfolgung zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Nutzungsverfolgung.
