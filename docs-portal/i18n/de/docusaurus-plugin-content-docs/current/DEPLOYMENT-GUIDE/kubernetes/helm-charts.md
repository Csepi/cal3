---
title: "Helmkarten"
description: "Schritt-für-Schritt-Anleitung für Steuerkarten in PrimeCalendar."
...
# Helmkarten {#helm-charts}

> **Kurze Zusammenfassung**: Auf dieser Seite werden Ruderkarten in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um Steuerkarten zuverlässig auszufüllen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten für Steuerkarten.
