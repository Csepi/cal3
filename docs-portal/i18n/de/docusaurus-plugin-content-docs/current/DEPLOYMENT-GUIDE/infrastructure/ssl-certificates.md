...
description: "Schritt-für-Schritt-Anleitung für SSL-Zertifikate in PrimeCalendar."
...
> **Kurze Zusammenfassung**: Auf dieser Seite werden SSL-Zertifikate in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um SSL-Zertifikate zuverlässig auszufüllen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für SSL-Zertifikate.
