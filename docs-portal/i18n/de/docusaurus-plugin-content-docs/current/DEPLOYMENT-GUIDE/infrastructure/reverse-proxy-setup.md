...
description: "Schritt-für-Schritt-Anleitung für die Reverse-Proxy-Einrichtung in PrimeCalendar."
...
> **Kurze Zusammenfassung**: Auf dieser Seite wird die Reverse-Proxy-Einrichtung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Reverse-Proxy-Einrichtung zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Reverse-Proxy-Einrichtung.
