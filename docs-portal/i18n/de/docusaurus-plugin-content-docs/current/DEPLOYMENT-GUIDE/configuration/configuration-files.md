...
description: "Schritt-für-Schritt-Anleitung für Konfigurationsdateien in PrimeCalendar."
...
> **Kurze Zusammenfassung**: Auf dieser Seite werden Konfigurationsdateien in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um Konfigurationsdateien zuverlässig zu vervollständigen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Konfigurationsdateien.
...
- `CONFIGURATION_GUIDE.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: DEPLOYMENT-GUIDE/configuration/configuration-files.md – Archivierter Snapshot: archives/pre-consolidation/CONFIGURATION_GUIDE.md
