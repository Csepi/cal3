...
description: "Schritt-für-Schritt-Anleitung für die OAuth-Konfiguration in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, configuration, oauth, primecalendar]
---

# OAuth Konfiguration {#oauth-configuration}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die OAuth-Konfiguration in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die OAuth-Konfiguration zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die OAuth-Konfiguration.
