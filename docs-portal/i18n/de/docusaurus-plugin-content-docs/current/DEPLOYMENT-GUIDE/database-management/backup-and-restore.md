...
description: "Schritt-für-Schritt-Anleitung für Sicherung und Wiederherstellung in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, database, management, backup, and, restore, primecalendar]
---

# Sichern und Wiederherstellen {#backup-and-restore}

> **Kurze Zusammenfassung**: Auf dieser Seite werden die Sicherung und Wiederherstellung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Sicherung und Wiederherstellung zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Sicherung und Wiederherstellung.
...
- `07-DEPLOYMENT/database-backup.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: DEPLOYMENT-GUIDE/database-management/backup-and-restore.md – Archivierter Snapshot: archives/pre-consolidation/07-DEPLOYMENT/database-backup.md
