...
description: "Schritt-für-Schritt-Anleitung für die Datenbankmigration in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, database, management, migration, primecalendar]
---

# Datenbankmigration {#database-migration}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Datenbankmigration in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Datenbankmigration zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Datenbankmigration.
