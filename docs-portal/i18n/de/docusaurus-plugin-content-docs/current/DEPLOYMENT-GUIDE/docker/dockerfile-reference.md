---
title: "Dockerfile-Referenz"
description: "Schritt-für-Schritt-Anleitung für die Dockerfile-Referenz in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, docker, dockerfile, reference, primecalendar]
---

# Dockerfile-Referenz {#dockerfile-reference}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Dockerfile-Referenz in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Dockerfile-Referenz zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Dockerfile-Referenz.
...
- `docker/BUILD_AND_DEBUG.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: DEPLOYMENT-GUIDE/docker/dockerfile-reference.md – Archivierter Snapshot: archives/pre-consolidation/docker/BUILD_AND_DEBUG.md
