---
title: "Selbstgehostete Übersicht"
description: "Schritt-für-Schritt-Anleitung für eine selbst gehostete Übersicht in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, options, self, hosted, overview, primecalendar]
---

# Selbstgehostete Übersicht {#self-hosted-overview}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die selbstgehostete Übersicht in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die selbst gehostete Übersicht zuverlässig zu vervollständigen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für den selbstgehosteten Überblick.
...
- `07-DEPLOYMENT/production-setup.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: DEPLOYMENT-GUIDE/deployment-options/self-hosted-overview.md – Archivierter Snapshot: archives/pre-consolidation/07-DEPLOYMENT/produktion-setup.md
