...
description: "Schritt-für-Schritt-Anleitung für die Kubernetes-Bereitstellung in PrimeCalendar."
...
> **Kurze Zusammenfassung**: Auf dieser Seite wird die Kubernetes-Bereitstellung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Kubernetes-Bereitstellung zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Kubernetes-Bereitstellung.
