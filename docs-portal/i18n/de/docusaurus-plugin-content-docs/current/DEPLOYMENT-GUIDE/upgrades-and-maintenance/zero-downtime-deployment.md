---
title: "Bereitstellung ohne Ausfallzeiten"
description: "Schritt-für-Schritt-Anleitung für die Bereitstellung ohne Ausfallzeiten in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, upgrades, and, maintenance, zero, downtime, primecalendar]
---

# Bereitstellung ohne Ausfallzeiten {#zero-downtime-deployment}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Zero-Downtime-Bereitstellung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die Bereitstellung ohne Ausfallzeiten zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für eine Bereitstellung ohne Ausfallzeiten.
