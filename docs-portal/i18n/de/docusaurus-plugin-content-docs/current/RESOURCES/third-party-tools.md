...
description: "Schritt-für-Schritt-Anleitung für Tools von Drittanbietern in PrimeCalendar."
category: "Ressourcen"
...
# Tools von Drittanbietern {#third-party-tools}

> **Kurze Zusammenfassung**: Auf dieser Seite werden Tools von Drittanbietern in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um Tools von Drittanbietern zuverlässig auszuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Tools von Drittanbietern.
