...
description: "Schritt-für-Schritt-Anleitung für den Support-Kontakt in PrimeCalendar."
category: "Ressourcen"
...
> **Kurze Zusammenfassung**: Auf dieser Seite wird der Support-Kontakt in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Nutzen Sie diese Anleitung, um den Support-Kontakt zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten bei der Kontaktaufnahme mit dem Support.
