---
title: "Selbstgehostetes Kubernetes"
description: "Schritt-für-Schritt-Anleitung für selbst gehostete Kubernetes in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [getting, started, installation, self, hosted, kubernetes, primecalendar]
---

# Selbstgehostetes Kubernetes {#self-hosted-kubernetes}

> **Kurze Zusammenfassung**: Auf dieser Seite werden selbst gehostete Kubernetes in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um selbst gehostete Kubernetes zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für selbst gehostete Kubernetes.
