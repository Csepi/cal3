...
description: "Schritt-für-Schritt-Anleitung für die lokale Entwicklung in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [getting, started, installation, local, development, primecalendar]
---

# Lokale Entwicklung {#local-development}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die lokale Entwicklung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die lokale Entwicklung zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für die lokale Entwicklung.
...
- `01-GETTING-STARTED/database-setup.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: GETTING-STARTED/installation/local-development.md – Archivierter Snapshot: archives/pre-consolidation/01-GETTING-STARTED/database-setup.md
- `01-GETTING-STARTED/installation.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: GETTING-STARTED/installation/local-development.md – Archivierter Snapshot: archives/pre-consolidation/01-GETTING-STARTED/installation.md
