---
title: "Selbstgehosteter Docker"
description: "Schritt-für-Schritt-Anleitung für selbst gehosteten Docker in PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [getting, started, installation, self, hosted, docker, primecalendar]
---

# Selbstgehosteter Docker {#self-hosted-docker}

> **Kurze Zusammenfassung**: Auf dieser Seite wird der selbstgehostete Docker in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um selbst gehosteten Docker zuverlässig auszuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für selbst gehostete Docker.
...
- `01-GETTING-STARTED/docker-setup.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: GETTING-STARTED/installation/self-hosted-docker.md – Archivierter Snapshot: archives/pre-consolidation/01-GETTING-STARTED/docker-setup.md
