---
title: "Glossar"
description: "Schritt-für-Schritt-Anleitung für das Glossar in PrimeCalendar."
...
related:
  - index.md
  - ../index.md
tags: [getting, started, glossary, primecalendar]
---

# Glossar {#glossary}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Glossar in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um das Glossar zuverlässig zu vervollständigen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für das Glossar.
...
- `GLOSSARY.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: GETTING-STARTED/glossary.md – Archivierter Schnappschuss: archives/pre-consolidation/GLOSSARY.md
