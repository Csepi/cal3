...
description: "Schritt-für-Schritt-Anleitung für den Authentifizierungsablauf in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, architecture, authentication, flow, primecalendar]
---

# Authentifizierungsablauf {#authentication-flow}

> **Kurze Zusammenfassung**: Auf dieser Seite wird der Authentifizierungsablauf in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um den Authentifizierungsablauf zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für den Authentifizierungsfluss.
