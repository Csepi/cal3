...
description: "Schritt-für-Schritt-Anleitung für das Datenbankschema in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, architecture, database, schema, primecalendar]
---

# Datenbankschema {#database-schema}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Datenbankschema in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um das Datenbankschema zuverlässig zu vervollständigen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für das Datenbankschema.
...
- `02-ARCHITECTURE/database-schema.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: DEVELOPER-GUIDE/architecture/database-schema.md – Archivierter Snapshot: archives/pre-consolidation/02-ARCHITECTURE/database-schema.md
