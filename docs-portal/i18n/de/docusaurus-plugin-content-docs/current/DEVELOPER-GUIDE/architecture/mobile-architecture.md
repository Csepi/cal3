...
description: "Schritt-für-Schritt-Anleitung für die mobile Architektur in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, architecture, mobile, primecalendar]
---

# Mobile Architektur {#mobile-architecture}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die mobile Architektur in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die mobile Architektur zuverlässig fertigzustellen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für die mobile Architektur.
