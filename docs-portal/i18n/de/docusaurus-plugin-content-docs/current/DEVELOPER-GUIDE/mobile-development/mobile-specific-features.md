---
title: "Mobile-spezifische Funktionen"
description: "Schritt-für-Schritt-Anleitung für mobilspezifische Funktionen in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
# Mobile-spezifische Funktionen {#mobile-specific-features}

> **Kurze Zusammenfassung**: Auf dieser Seite werden mobilspezifische Funktionen in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um mobilspezifische Funktionen zuverlässig auszuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für mobilspezifische Funktionen.
