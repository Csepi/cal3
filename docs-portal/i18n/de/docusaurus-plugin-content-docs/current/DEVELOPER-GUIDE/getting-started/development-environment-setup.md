...
description: "Schritt-für-Schritt-Anleitung für die Einrichtung der Entwicklungsumgebung in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
# Einrichtung der Entwicklungsumgebung {#development-environment-setup}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Einrichtung der Entwicklungsumgebung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Einrichtung der Entwicklungsumgebung zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Einrichtung der Entwicklungsumgebung.
...
- `06-DEVELOPER-GUIDES/local-setup.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: DEVELOPER-GUIDE/getting-started/development-environment-setup.md – Archivierter Snapshot: archives/pre-consolidation/06-DEVELOPER-GUIDES/local-setup.md
