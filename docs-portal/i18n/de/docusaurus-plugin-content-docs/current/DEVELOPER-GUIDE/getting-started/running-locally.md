...
description: "Schritt-für-Schritt-Anleitung für die lokale Ausführung in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, getting, started, running, locally, primecalendar]
---

# Lokal ausgeführt {#running-locally}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die lokale Ausführung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die lokale Ausführung zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für die lokale Ausführung.
