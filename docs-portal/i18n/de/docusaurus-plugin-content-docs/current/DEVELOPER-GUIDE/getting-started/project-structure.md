...
description: "Schritt-für-Schritt-Anleitung zur Projektstruktur in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
> **Kurze Zusammenfassung**: Auf dieser Seite wird die Projektstruktur in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die Projektstruktur zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Projektstruktur.
...
- `06-DEVELOPER-GUIDES/code-organization.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: DEVELOPER-GUIDE/getting-started/project-structure.md – Archivierter Schnappschuss: archives/pre-consolidation/06-DEVELOPER-GUIDES/code-organization.md
