---
title: "Codierungsstandards"
description: "Schritt-für-Schritt-Anleitung für Codierungsstandards in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, getting, started, coding, standards, primecalendar]
---

# Codierungsstandards {#coding-standards}

> **Kurze Zusammenfassung**: Auf dieser Seite werden die Codierungsstandards in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um Codierungsstandards zuverlässig zu vervollständigen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Codierungsstandards.
