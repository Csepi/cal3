---
title: "Autorisierungsdekorateure"
description: "Schritt-für-Schritt-Anleitung für Autorisierungsdekorateure in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, backend, development, authorization, decorators, primecalendar]
---

# Autorisierungsdekorateure {#authorization-decorators}

> **Kurze Zusammenfassung**: Auf dieser Seite werden Autorisierungsdekoratoren in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um Authorization Decorators zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für Autorisierungsdekorateure.
