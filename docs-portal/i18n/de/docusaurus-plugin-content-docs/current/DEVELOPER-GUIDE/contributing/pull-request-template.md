---
title: "Pull-Request-Vorlage"
description: "Schritt-für-Schritt-Anleitung für die Pull-Request-Vorlage in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, contributing, pull, request, template, primecalendar]
---

# Pull-Request-Vorlage {#pull-request-template}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Pull-Request-Vorlage in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Pull-Request-Vorlage zuverlässig auszufüllen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten für die Pull-Request-Vorlage.
