---
title: "Problemberichterstattung"
description: "Schritt-für-Schritt-Anleitung für die Problemberichterstattung in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, contributing, issue, reporting, primecalendar]
---

# Problemberichterstattung {#issue-reporting}

> **Kurze Zusammenfassung**: Auf dieser Seite wird die Problemmeldung in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um die Problemberichterstattung zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein einheitliches Verhalten bei der Problemmeldung.
