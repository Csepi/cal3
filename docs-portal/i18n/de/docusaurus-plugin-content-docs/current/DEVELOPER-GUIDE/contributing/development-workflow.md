...
description: "Schritt-für-Schritt-Anleitung für den Entwicklungsworkflow in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
> **Kurze Zusammenfassung**: Auf dieser Seite wird der Entwicklungsworkflow in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um den Entwicklungsworkflow zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für den Entwicklungsworkflow.
...
- `security/repo-hygiene.md`: Diese Seite wurde in die konsolidierte Struktur verschoben. – Kanonische Seite: DEVELOPER-GUIDE/contributing/development-workflow.md – Archivierter Snapshot: archives/pre-consolidation/security/repo-hygiene.md
