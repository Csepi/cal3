---
title: "Unit-Tests"
description: "Schritt-für-Schritt-Anleitung für Unit-Tests in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
> **Kurze Zusammenfassung**: Auf dieser Seite werden Unit-Tests in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diesen Leitfaden, um Unit-Tests zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für Unit-Tests.
