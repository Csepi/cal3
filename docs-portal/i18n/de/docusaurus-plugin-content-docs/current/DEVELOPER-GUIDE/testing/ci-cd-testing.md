---
title: "Ci-CD-Test"
description: "Schritt-für-Schritt-Anleitung für CI-CD-Tests in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
# Ci-CD-Test {#ci-cd-testing}

> **Kurze Zusammenfassung**: Auf dieser Seite werden CI-CD-Tests in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um den CI-CD-Test zuverlässig durchzuführen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt konsistentes Verhalten für CI-CD-Tests.
