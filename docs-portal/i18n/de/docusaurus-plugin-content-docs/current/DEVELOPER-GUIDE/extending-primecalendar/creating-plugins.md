...
description: "Schritt-für-Schritt-Anleitung zum Erstellen von Plugins in PrimeCalendar."
category: "Entwickler"
audience: "Entwickler"
...
# Plugins erstellen {#creating-plugins}

> **Kurze Zusammenfassung**: Auf dieser Seite wird das Erstellen von Plugins in PrimeCalendar anhand praktischer Schritte und Anleitungen zur Fehlerbehebung erläutert.
...
Verwenden Sie diese Anleitung, um die Erstellung von Plugins zuverlässig abzuschließen. Bestätigen Sie nach jedem Schritt die erwarteten Ergebnisse, bevor Sie zu den optionalen erweiterten Einstellungen wechseln.
...
**Szenario**: Ihr Team benötigt ein konsistentes Verhalten beim Erstellen von Plugins.
