...
description: "Commencez par l'inscription, passez à la planification quotidienne, puis continuez avec l'automatisation, MCP, la synchronisation et la référence complète API."
...
<div class="pc-guide-hero">
  ...
  <p class="pc-guide-hero__lead">Commencez par l'enregistrement et la configuration, continuez dans l'espace de travail quotidien PrimeCal, puis passez à l'automatisation, à la synchronisation externe, aux agents IA et à la référence complète du développeur.</p>
  <div class="pc-guide-chip-row">
    <span class="pc-guide-chip">Captures d'écran de produits réels</span>
    <span class="pc-guide-chip">Système de couleurs PrimeCal</span>
    <span class="pc-guide-chip">Structure axée sur l'utilisateur</span>
    <span class="pc-guide-chip">Basé sur du code API docs</span>
  </div>
</div>
...
## PrimeCal Caractéristiques {#primecal-features}
...
## Voyage recommandé {#recommended-journey}
...
<p>Commencez avec <Link to="/GETTING-STARTED/quick-start-guide">Guide de démarrage rapide</Link> et la procédure d'inscription détaillée.</p>
  ...
  <article class="pc-guide-flow__item">
    ...
    <h3>Configurer votre espace</h3>
    <p>Terminez votre profil, créez de vrais calendriers, regroupez-les et configurez le mode Focus en fonction de votre planification.</p>
  </article>
  <article class="pc-guide-flow__item">
    <div class="pc-guide-flow__index">3</div>
    <h3>Exécuter le travail quotidien</h3>
    <p>Utilisez les calendriers, les événements, les tâches et les journaux personnels comme surface de travail normale pour un utilisateur réel.</p>
  </article>
  <article class="pc-guide-flow__item">
    <div class="pc-guide-flow__index">4</div>
    <h3>Ajouter des fonctionnalités d'alimentation</h3>
    <p>Passez aux agents d'automatisation, de synchronisation externe et d'IA lorsque le travail manuel commence à se répéter.</p>
  </article>
  <article class="pc-guide-flow__item">
    <div class="pc-guide-flow__index">5</div>
    <h3>Construire des intégrations</h3>
    <p>Utilisez le guide du développeur lorsque vous avez besoin des contrats backend, des exemples, des restrictions et de la couverture API non-administrateur.</p>
  </article>
</div>

## Navigation dans les fonctionnalités {#feature-navigation}

De nombreux outils avancés se trouvent sous `More` dans le shell de l'application, afin que les utilisateurs puissent les découvrir à partir d'un seul endroit après avoir compris le calendrier.
