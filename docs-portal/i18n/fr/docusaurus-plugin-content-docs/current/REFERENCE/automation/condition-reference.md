---
title: "Référence de l'état"
description: "Conseils étape par étape pour la référence de condition dans PrimeCalendar."
category: "Référence"
...
# Référence de l'état {#condition-reference}

> **Résumé rapide** : cette page explique la référence de condition dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence de condition de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour référence de condition.
