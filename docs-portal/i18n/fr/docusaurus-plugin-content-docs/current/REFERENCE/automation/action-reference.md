...
description: "Conseils étape par étape pour la référence d’action dans PrimeCalendar."
category: "Référence"
...
# Référence des actions {#action-reference}

> **Résumé rapide** : cette page explique la référence aux actions dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence d’action de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour référence d'action.
