---
title: "Référence du déclencheur"
description: "Conseils étape par étape pour la référence du déclencheur dans PrimeCalendar."
category: "Référence"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, automation, trigger, primecalendar]
---

# Référence du déclencheur {#trigger-reference}

> **Résumé rapide** : cette page explique la référence du déclencheur dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence du déclencheur de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour référence de déclenchement.
