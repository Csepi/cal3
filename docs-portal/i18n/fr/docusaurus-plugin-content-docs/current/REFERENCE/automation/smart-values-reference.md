---
title: "Référence des valeurs intelligentes"
description: "Conseils étape par étape pour la référence des valeurs intelligentes dans PrimeCalendar."
category: "Référence"
...
# Référence des valeurs intelligentes {#smart-values-reference}

> **Résumé rapide** : cette page explique la référence aux valeurs intelligentes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence des valeurs intelligentes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour référencer des valeurs intelligentes.
