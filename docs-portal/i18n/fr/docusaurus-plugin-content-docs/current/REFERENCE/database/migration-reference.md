---
title: "Référence de migration"
description: "Conseils étape par étape pour la référence de migration dans PrimeCalendar."
category: "Référence"
...
# Référence de migration {#migration-reference}

> **Résumé rapide** : cette page explique la référence de migration dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence de migration de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour référence de migration.
...
- `external-database/QUICK_REFERENCE.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : REFERENCE/database/migration-reference.md - Instantané archivé : archives/pre-consolidation/external-database/QUICK_REFERENCE.md
