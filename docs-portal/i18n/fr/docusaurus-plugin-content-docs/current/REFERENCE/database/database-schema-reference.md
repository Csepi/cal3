...
description: "Conseils étape par étape pour la référence du schéma de base de données dans PrimeCalendar."
category: "Référence"
...
# Référence du schéma de base de données {#database-schema-reference}

> **Résumé rapide** : cette page explique la référence du schéma de base de données dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence du schéma de base de données de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la référence du schéma de base de données.
