...
description: "Conseils étape par étape pour la référence aux variables d’environnement dans PrimeCalendar."
category: "Référence"
...
# Référence des variables d'environnement {#environment-variables-reference}

> **Résumé rapide** : cette page explique la référence aux variables d'environnement dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence des variables d’environnement de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la référence aux variables d'environnement.
