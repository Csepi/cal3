---
title: "Référence des indicateurs de fonctionnalité"
description: "Conseils étape par étape pour la référence aux indicateurs de fonctionnalités dans PrimeCalendar."
category: "Référence"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, configuration, feature, flags, primecalendar]
---

# Référence des indicateurs de fonctionnalité {#feature-flags-reference}

> **Résumé rapide** : cette page explique la référence aux indicateurs de fonctionnalités dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence des indicateurs de fonctionnalités de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la référence aux indicateurs de fonctionnalité.
