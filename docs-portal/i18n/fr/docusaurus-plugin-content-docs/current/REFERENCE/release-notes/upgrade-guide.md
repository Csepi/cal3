...
description: "Conseils étape par étape pour le guide de mise à niveau dans PrimeCalendar."
category: "Référence"
...
> **Résumé rapide** : cette page explique le guide de mise à niveau dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le guide de mise à niveau de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour le guide de mise à niveau.
