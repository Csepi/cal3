---
title: "Version 1.3.0"
description: "Conseils étape par étape pour la version 1.3.0 dans PrimeCalendar."
category: "Référence"
...
> **Résumé rapide** : cette page explique la version 1.3.0 dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la version 1.3.0 de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la version 1.3.0.
