...
description: "Conseils étape par étape pour le journal des modifications dans PrimeCalendar."
category: "Référence"
...
> **Résumé rapide** : cette page explique le journal des modifications dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le journal des modifications de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le journal des modifications.
...
- `releases/tasks-mcp-rollout.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : REFERENCE/release-notes/changelog.md - Instantané archivé : archives/pre-consolidation/releases/tasks-mcp-rollout.md
