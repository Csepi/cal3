---
title: "Référence Graphql API"
description: "Conseils étape par étape pour la référence de l'API graphql dans PrimeCalendar."
category: "Référence"
...
# Référence Graphql API {#graphql-api-reference}

> **Résumé rapide** : cette page explique la référence de l'API graphql dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence de l'API graphql de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la référence de l'API graphql.
