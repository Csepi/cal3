---
title: "Reste API Référence"
description: "Conseils étape par étape pour la référence de l’API Rest dans PrimeCalendar."
category: "Référence"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, api, rest, primecalendar]
---

# Reste API Référence {#rest-api-reference}

> **Résumé rapide** : cette page explique la référence de l'API Rest dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence de l’API Rest de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la référence de l'API Rest.
...
- `04-API-REFERENCE/error-codes.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : REFERENCE/api/rest-api-reference.md - Instantané archivé : archives/pre-consolidation/04-API-REFERENCE/error-codes.md
