---
title: "API Journal des modifications"
description: "Conseils étape par étape pour le journal des modifications de l'API dans PrimeCalendar."
category: "Référence"
...
related:
  - ../index.md
  - ../../index.md
tags: [reference, api, changelog, primecalendar]
---

# API Journal des modifications {#api-changelog}

> **Résumé rapide** : cette page explique le journal des modifications de l'API dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le journal des modifications de l'API de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le journal des modifications de l'API.
