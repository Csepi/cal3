---
title: "Problèmes Kubernetes"
description: "Conseils étape par étape pour les problèmes de Kubernetes dans PrimeCalendar."
category: "Dépannage"
...
# Problèmes Kubernetes {#kubernetes-issues}

> **Résumé rapide** : cette page explique les problèmes de Kubernetes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour résoudre les problèmes Kubernetes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les problèmes de Kubernetes.
