...
description: "Conseils étape par étape pour le débogage des applications mobiles dans PrimeCalendar."
category: "Dépannage"
...
# Débogage d'applications mobiles {#mobile-app-debugging}

> **Résumé rapide** : cette page explique le débogage des applications mobiles dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer le débogage des applications mobiles de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le débogage des applications mobiles.
