---
title: "Débogage back-end"
description: "Conseils étape par étape pour le débogage backend dans PrimeCalendar."
category: "Dépannage"
...
# Débogage back-end {#backend-debugging}

> **Résumé rapide** : cette page explique le débogage backend dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer le débogage backend de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour le débogage du backend.
...
- `06-DEVELOPER-GUIDES/debugging.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : TROUBLESHOOTING/debugging-guides/backend-debugging.md - Instantané archivé : archives/pre-consolidation/06-DEVELOPER-GUIDES/debugging.md
- `09-TROUBLESHOOTING/logs-debugging.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : TROUBLESHOOTING/debugging-guides/backend-debugging.md - Instantané archivé : archives/pre-consolidation/09-TROUBLESHOOTING/logs-debugging.md
