---
title: "Débogage frontal"
description: "Conseils étape par étape pour le débogage du frontend dans PrimeCalendar."
category: "Dépannage"
...
# Débogage frontal {#frontend-debugging}

> **Résumé rapide** : cette page explique le débogage du frontend dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer le débogage frontend de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le débogage frontend.
