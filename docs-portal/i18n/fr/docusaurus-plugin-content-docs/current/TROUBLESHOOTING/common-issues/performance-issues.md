...
description: "Conseils étape par étape pour les problèmes de performances dans PrimeCalendar."
category: "Dépannage"
...
> **Résumé rapide** : cette page explique les problèmes de performances dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour résoudre les problèmes de performances de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent en cas de problèmes de performances.
...
- `09-TROUBLESHOOTING/performance-issues.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : TROUBLESHOOTING/common-issues/performance-issues.md - Instantané archivé : archives/pre-consolidation/09-TROUBLESHOOTING/performance-issues.md
