---
title: "Problèmes de partage de calendrier"
description: "Conseils étape par étape pour les problèmes de partage d’agenda dans PrimeCalendar."
category: "Dépannage"
...
# Problèmes de partage de calendrier {#calendar-sharing-issues}

> **Résumé rapide** : cette page explique les problèmes de partage d'agenda dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour résoudre les problèmes de partage de calendrier de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent en cas de problèmes de partage d'agenda.
