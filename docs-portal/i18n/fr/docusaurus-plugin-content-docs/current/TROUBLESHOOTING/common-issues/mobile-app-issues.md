---
title: "Problèmes d'application mobile"
description: "Conseils étape par étape pour les problèmes liés aux applications mobiles dans PrimeCalendar."
category: "Dépannage"
...
# Problèmes d'application mobile {#mobile-app-issues}

> **Résumé rapide** : cette page explique les problèmes liés aux applications mobiles dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour résoudre les problèmes liés aux applications mobiles de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent en cas de problèmes liés aux applications mobiles.
...
- `09-TROUBLESHOOTING/smart-home-issues.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : TROUBLESHOOTING/common-issues/mobile-app-issues.md - Instantané archivé : archives/pre-consolidation/09-TROUBLESHOOTING/smart-home-issues.md
