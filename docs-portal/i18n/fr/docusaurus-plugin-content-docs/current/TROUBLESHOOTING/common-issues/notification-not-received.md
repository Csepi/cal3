...
description: "Conseils étape par étape pour les notifications non reçues dans PrimeCalendar."
category: "Dépannage"
...
# Notification non reçue {#notification-not-received}

> **Résumé rapide** : cette page explique la notification non reçue dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la notification non reçue de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent en cas de notification non reçue.
