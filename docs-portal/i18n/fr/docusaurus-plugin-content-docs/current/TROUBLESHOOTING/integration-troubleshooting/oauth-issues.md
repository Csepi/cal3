---
title: "OAuth Problèmes"
description: "Conseils étape par étape pour les problèmes oauth dans PrimeCalendar."
category: "Dépannage"
...
# OAuth Problèmes {#oauth-issues}

> **Résumé rapide** : cette page explique les problèmes oauth dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour résoudre les problèmes oauth de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les problèmes oauth.
