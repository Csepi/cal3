...
description: "Conseils étape par étape pour la configuration des ports dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la configuration du port dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la configuration des ports de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la configuration des ports.
...
- `PORT_CONFIGURATION.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/configuration/port-configuration.md - Instantané archivé : archives/pre-consolidation/PORT_CONFIGURATION.md
- `SIMPLE_PORT_CONFIG.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/configuration/port-configuration.md - Instantané archivé : archives/pre-consolidation/SIMPLE_PORT_CONFIG.md
