...
description: "Conseils étape par étape pour les fichiers de configuration dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique les fichiers de configuration dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les fichiers de configuration de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les fichiers de configuration.
...
- `CONFIGURATION_GUIDE.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/configuration/configuration-files.md - Instantané archivé : archives/pre-consolidation/CONFIGURATION_GUIDE.md
