---
title: "Configuration d'entrée"
description: "Conseils étape par étape pour la configuration d’entrée dans PrimeCalendar."
...
# Configuration d'entrée {#ingress-configuration}

> **Résumé rapide** : cette page explique la configuration d'entrée dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer la configuration d’entrée de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la configuration d'entrée.
