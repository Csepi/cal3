---
title: "Les secrets de Kubernetes"
description: "Conseils étape par étape pour les secrets de Kubernetes dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, kubernetes, secrets, primecalendar]
---

# Les secrets de Kubernetes {#kubernetes-secrets}

> **Résumé rapide** : cette page explique les secrets de Kubernetes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les secrets de Kubernetes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les secrets Kubernetes.
