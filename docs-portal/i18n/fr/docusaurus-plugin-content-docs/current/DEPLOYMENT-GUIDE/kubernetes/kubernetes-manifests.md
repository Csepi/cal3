---
title: "Manifestes Kubernetes"
description: "Des conseils étape par étape pour les manifestes Kubernetes se trouvent dans PrimeCalendar."
...
# Manifestes Kubernetes {#kubernetes-manifests}

> **Résumé rapide** : cette page explique les manifestes Kubernetes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les manifestes Kubernetes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les manifestes Kubernetes.
...
- `07-DEPLOYMENT/kubernetes.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/kubernetes/kubernetes-manifests.md - Instantané archivé : archives/pre-consolidation/07-DEPLOYMENT/kubernetes.md
