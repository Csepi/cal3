...
description: "Conseils étape par étape pour les fenêtres de maintenance dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique les fenêtres de maintenance dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer les fenêtres de maintenance de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les fenêtres de maintenance.
