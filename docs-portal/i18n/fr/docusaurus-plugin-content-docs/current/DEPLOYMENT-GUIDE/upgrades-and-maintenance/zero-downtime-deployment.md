...
description: "Conseils étape par étape pour un déploiement sans temps d'arrêt dans PrimeCalendar."
...
# Déploiement sans temps d'arrêt {#zero-downtime-deployment}

> **Résumé rapide** : cette page explique le déploiement sans temps d'arrêt dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer un déploiement sans temps d'arrêt de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour un déploiement sans temps d'arrêt.
