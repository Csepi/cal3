...
description: "Conseils étape par étape pour le regroupement de connexions dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique le regroupement de connexions dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer le regroupement de connexions de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le regroupement de connexions.
