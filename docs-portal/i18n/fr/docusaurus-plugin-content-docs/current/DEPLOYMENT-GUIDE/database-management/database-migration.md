...
description: "Conseils étape par étape pour la migration de la base de données dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la migration de la base de données dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer la migration de la base de données de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour la migration de la base de données.
