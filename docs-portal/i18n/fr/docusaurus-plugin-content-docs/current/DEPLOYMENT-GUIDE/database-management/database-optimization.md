...
description: "Conseils étape par étape pour l’optimisation de la base de données dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, database, management, optimization, primecalendar]
---

# Optimisation de la base de données {#database-optimization}

> **Résumé rapide** : cette page explique l'optimisation de la base de données dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer l’optimisation de la base de données de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'optimisation de la base de données.
