...
description: "Conseils étape par étape pour la sauvegarde et la restauration dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la sauvegarde et la restauration dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer une sauvegarde et une restauration de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la sauvegarde et la restauration.
...
- `07-DEPLOYMENT/database-backup.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/database-management/backup-and-restore.md - Instantané archivé : archives/pre-consolidation/07-DEPLOYMENT/database-backup.md
