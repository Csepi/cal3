...
description: "Conseils étape par étape pour la connexion à une base de données externe dans PrimeCalendar."
...
# Connexion à une base de données externe {#external-database-connection}

> **Résumé rapide** : cette page explique la connexion à une base de données externe dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour établir une connexion à une base de données externe de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour la connexion à une base de données externe.
...
- `external-database/INDEX.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/database-management/external-database-connection.md - Instantané archivé : archives/pre-consolidation/external-database/INDEX.md
