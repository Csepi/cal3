---
title: "Déploiement de Kubernetes"
description: "Conseils étape par étape pour le déploiement de Kubernetes dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [deployment, options, kubernetes, primecalendar]
---

# Déploiement de Kubernetes {#kubernetes-deployment}

> **Résumé rapide** : cette page explique le déploiement de Kubernetes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer le déploiement de Kubernetes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le déploiement de Kubernetes.
