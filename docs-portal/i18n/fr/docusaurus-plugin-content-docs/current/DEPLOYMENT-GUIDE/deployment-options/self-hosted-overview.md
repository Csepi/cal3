---
title: "Aperçu auto-hébergé"
description: "Conseils étape par étape pour un aperçu auto-hébergé dans PrimeCalendar."
...
# Aperçu auto-hébergé {#self-hosted-overview}

> **Résumé rapide** : cette page explique la présentation auto-hébergée dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter de manière fiable une présentation auto-hébergée. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour une vue d'ensemble auto-hébergée.
...
- `07-DEPLOYMENT/production-setup.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/deployment-options/self-hosted-overview.md - Instantané archivé : archives/pre-consolidation/07-DEPLOYMENT/production-setup.md
