...
description: "Conseils étape par étape pour la comparaison des plates-formes dans PrimeCalendar."
...
# Comparaison des plateformes {#platform-comparison}

> **Résumé rapide** : cette page explique la comparaison des plates-formes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer une comparaison de plates-formes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour comparer les plates-formes.
