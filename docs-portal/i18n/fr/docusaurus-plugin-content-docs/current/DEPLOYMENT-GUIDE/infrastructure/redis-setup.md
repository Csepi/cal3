...
description: "Conseils étape par étape pour la configuration de Redis dans PrimeCalendar."
...
# Configuration Redis {#redis-setup}

> **Résumé rapide** : cette page explique la configuration de Redis dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la configuration de Redis de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la configuration de Redis.
