...
description: "Conseils étape par étape pour la configuration du proxy inverse dans PrimeCalendar."
...
# Configuration du proxy inverse {#reverse-proxy-setup}

> **Résumé rapide** : cette page explique la configuration du proxy inverse dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la configuration du proxy inverse de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la configuration du proxy inverse.
