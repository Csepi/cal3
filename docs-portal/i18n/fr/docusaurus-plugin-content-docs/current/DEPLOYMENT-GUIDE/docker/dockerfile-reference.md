---
title: "Référence du fichier Docker"
description: "Conseils étape par étape pour la référence du fichier docker dans PrimeCalendar."
...
# Référence du fichier Docker {#dockerfile-reference}

> **Résumé rapide** : cette page explique la référence du fichier docker dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la référence dockerfile de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la référence du fichier docker.
...
- `docker/BUILD_AND_DEBUG.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/docker/dockerfile-reference.md - Instantané archivé : archives/pre-consolidation/docker/BUILD_AND_DEBUG.md
