...
description: "Conseils étape par étape pour la sécurité du Docker dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la sécurité du Docker dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la sécurité de Docker de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la sécurité de Docker.
...
- `DOCKER_SECURITY.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/docker/docker-security.md - Instantané archivé : archives/pre-consolidation/DOCKER_SECURITY.md
