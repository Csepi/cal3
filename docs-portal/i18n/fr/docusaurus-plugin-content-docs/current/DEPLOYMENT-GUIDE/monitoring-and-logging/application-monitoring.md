...
description: "Conseils étape par étape pour la surveillance des applications dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la surveillance des applications dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer la surveillance des applications de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la surveillance des applications.
...
- `07-DEPLOYMENT/monitoring.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEPLOYMENT-GUIDE/monitoring-and-logging/application-monitoring.md - Instantané archivé : archives/pre-consolidation/07-DEPLOYMENT/monitoring.md
