---
title: "Agrégation de journaux"
description: "Conseils étape par étape pour l’agrégation des journaux dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique l'agrégation des journaux dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer l’agrégation des journaux de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'agrégation des journaux.
