...
description: "Conseils étape par étape pour la configuration des alertes dans PrimeCalendar."
...
# Configuration des alertes {#alerting-setup}

> **Résumé rapide** : cette page explique la configuration des alertes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la configuration des alertes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la configuration des alertes.
