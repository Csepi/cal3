...
description: "Conseils étape par étape pour la surveillance des performances dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la surveillance des performances dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer une surveillance des performances de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le suivi des performances.
