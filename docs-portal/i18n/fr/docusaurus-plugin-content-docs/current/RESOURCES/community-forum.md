...
description: "Conseils étape par étape pour le forum communautaire dans PrimeCalendar."
category: "Ressources"
...
# Forum communautaire {#community-forum}

> **Résumé rapide** : cette page explique le forum communautaire dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le forum communautaire de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le forum communautaire.
