...
description: "Conseils étape par étape pour contacter l’assistance dans PrimeCalendar."
category: "Ressources"
...
# Contacter l'assistance {#support-contact}

> **Résumé rapide** : cette page explique le contact de l'assistance dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour contacter l'assistance de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour les contacts d'assistance.
