---
title: "Outils tiers"
description: "Conseils étape par étape pour les outils tiers dans PrimeCalendar."
category: "Ressources"
...
> **Résumé rapide** : cette page explique les outils tiers dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les outils tiers de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour les outils tiers.
