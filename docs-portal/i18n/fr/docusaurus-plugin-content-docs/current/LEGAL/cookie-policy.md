...
description: "Conseils étape par étape pour la politique en matière de cookies dans PrimeCalendar."
category: "Juridique"
...
related:
  - index.md
  - ../index.md
tags: [legal, cookie, policy, primecalendar]
---

# Politique en matière de cookies {#cookie-policy}

> **Résumé rapide** : Cette page explique la politique en matière de cookies dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la politique en matière de cookies de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent en matière de politique en matière de cookies.
