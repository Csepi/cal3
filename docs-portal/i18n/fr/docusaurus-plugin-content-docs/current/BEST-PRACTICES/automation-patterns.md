...
description: "Conseils étape par étape pour les modèles d'automatisation dans PrimeCalendar."
...
# Modèles d'automatisation {#automation-patterns}

> **Résumé rapide** : cette page explique les modèles d'automatisation dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les modèles d'automatisation de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les modèles d'automatisation.
