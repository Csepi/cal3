...
description: "Conseils étape par étape pour les directives d’accessibilité dans PrimeCalendar."
...
# Lignes directrices en matière d'accessibilité {#accessibility-guidelines}

> **Résumé rapide** : cette page explique les directives d'accessibilité dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les directives d’accessibilité de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les directives d'accessibilité.
