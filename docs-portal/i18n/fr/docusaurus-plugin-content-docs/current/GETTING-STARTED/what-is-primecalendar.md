---
title: "Qu'est-ce que Primecalendar"
description: "Des conseils étape par étape sur ce qu'est le calendrier principal dans PrimeCalendar."
category: "Commencer"
...
related:
  - index.md
  - ../index.md
tags: [getting, started, what, is, primecalendar]
---

# Qu'est-ce que Primecalendar {#what-is-primecalendar}

> **Résumé rapide** : Cette page explique ce qu'est le calendrier principal dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter de manière fiable ce qu'est le premier calendrier. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour ce qu'est le calendrier principal.
