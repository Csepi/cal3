---
title: "Glossaire"
description: "Conseils étape par étape pour le glossaire dans PrimeCalendar."
category: "Commencer"
...
> **Résumé rapide** : cette page explique le glossaire dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le glossaire de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le glossaire.
...
- `GLOSSARY.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : GETTING-STARTED/glossary.md - Instantané archivé : archives/pre-consolidation/GLOSSARY.md
