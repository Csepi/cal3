...
description: "Des conseils étape par étape pour le développement local en PrimeCalendar."
category: "Commencer"
...
> **Résumé rapide** : cette page explique le développement local dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour réaliser un développement local de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour le développement local.
...
- `01-GETTING-STARTED/database-setup.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : GETTING-STARTED/installation/local-development.md - Instantané archivé : archives/pre-consolidation/01-GETTING-STARTED/database-setup.md
- `01-GETTING-STARTED/installation.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : GETTING-STARTED/installation/local-development.md - Instantané archivé : archives/pre-consolidation/01-GETTING-STARTED/installation.md
