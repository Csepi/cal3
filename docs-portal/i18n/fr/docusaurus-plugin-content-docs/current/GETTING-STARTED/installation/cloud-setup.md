...
description: "Conseils étape par étape pour la configuration du cloud dans PrimeCalendar."
category: "Commencer"
...
# Configuration du cloud {#cloud-setup}

> **Résumé rapide** : cette page explique la configuration du cloud dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la configuration du cloud de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour la configuration du cloud.
