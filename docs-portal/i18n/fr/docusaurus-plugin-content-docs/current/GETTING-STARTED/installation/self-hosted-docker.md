---
title: "Docker auto-hébergé"
description: "Conseils étape par étape pour le Docker auto-hébergé dans PrimeCalendar."
category: "Commencer"
...
# Docker auto-hébergé {#self-hosted-docker}

> **Résumé rapide** : cette page explique le docker auto-hébergé dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le Docker auto-hébergé de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour Docker auto-hébergé.
...
- `01-GETTING-STARTED/docker-setup.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : GETTING-STARTED/installation/self-hosted-docker.md - Instantané archivé : archives/pre-consolidation/01-GETTING-STARTED/docker-setup.md
