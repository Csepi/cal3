...
description: "Des conseils étape par étape pour explorer l’interface dans PrimeCalendar."
category: "Commencer"
...
# Explorer l'interface {#exploring-the-interface}

> **Résumé rapide** : cette page explique l'exploration de l'interface dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer l’exploration de l’interface de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour explorer l'interface.
