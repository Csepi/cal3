---
title: "Inviter les membres de l'équipe"
description: "Conseils étape par étape pour inviter les membres de l’équipe dans PrimeCalendar."
category: "Commencer"
...
# Inviter les membres de l'équipe {#inviting-team-members}

> **Résumé rapide** : cette page explique l'invitation des membres de l'équipe dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer l’invitation des membres de l’équipe de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour inviter des membres de l'équipe.
