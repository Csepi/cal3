...
description: "Conseils étape par étape pour la configuration système requise dans PrimeCalendar."
category: "Commencer"
...
> **Résumé rapide** : cette page explique la configuration système requise dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour répondre de manière fiable à la configuration système requise. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent par rapport à la configuration système requise.
...
- `01-GETTING-STARTED/prerequisites.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : GETTING-STARTED/system-requirements.md - Instantané archivé : archives/pre-consolidation/01-GETTING-STARTED/prerequisites.md
