---
title: "Délégation et procurations"
description: "Conseils étape par étape pour la délégation et les procurations dans PrimeCalendar."
...
# Délégation et procurations {#delegation-and-proxies}

> **Résumé rapide** : cette page explique la délégation et les proxys dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer la délégation et les procurations de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la délégation et les proxys.
...
- `03-FEATURES/smart-home.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/advanced-features/delegation-and-proxies.md - Instantané archivé : archives/pre-consolidation/03-FEATURES/smart-home.md
- `05-USER-GUIDES/smart-home-guide.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/advanced-features/delegation-and-proxies.md - Instantané archivé : archives/pre-consolidation/05-USER-GUIDES/smart-home-guide.md
