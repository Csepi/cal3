---
title: "Importation et exportation iCalendar"
description: "Guide pas à pas pour l'importation et l'exportation iCalendar dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, advanced, features, icalendar, export, import, primecalendar]
---

# Importation et exportation iCalendar {#icalendar-export-import}

> **Résumé rapide** : Cette page explique l'importation et l'exportation d'icalendar dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer l’importation et l’exportation icalendar de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'importation et l'exportation d'icalendar.
...
- `08-MIGRATION/data-import.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/advanced-features/icalendar-export-import.md - Instantané archivé : archives/pre-consolidation/08-MIGRATION/data-import.md
