...
description: "Conseils étape par étape pour l’analyse des réunions dans PrimeCalendar."
...
# Analyse des réunions {#meeting-analytics}

> **Résumé rapide** : cette page explique l'analyse des réunions dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des analyses de réunion de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'analyse des réunions.
