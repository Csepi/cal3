---
title: "Fonctionnalités mobiles et Web"
description: "Conseils étape par étape pour les fonctionnalités mobiles et Web dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, mobile, app, vs, web, features, primecalendar]
---

# Fonctionnalités mobiles et Web {#mobile-vs-web-features}

> **Résumé rapide** : cette page explique les fonctionnalités mobiles et Web de PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les fonctionnalités mobiles par rapport au Web de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les fonctionnalités mobiles et Web.
