---
title: "Présentation de l'application mobile"
description: "Conseils étape par étape pour la présentation de l'application mobile dans PrimeCalendar."
...
# Présentation de l'application mobile {#mobile-app-overview}

> **Résumé rapide** : cette page explique la présentation de l'application mobile dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la présentation des applications mobiles de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la présentation des applications mobiles.
...
- `MOBILE_APP.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/mobile-app/mobile-app-overview.md - Instantané archivé : archives/pre-consolidation/MOBILE_APP.md
