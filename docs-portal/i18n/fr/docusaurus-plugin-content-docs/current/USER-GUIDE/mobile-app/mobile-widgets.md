---
title: "Widgets mobiles"
description: "Conseils étape par étape pour les widgets mobiles dans PrimeCalendar."
...
# Widgets mobiles {#mobile-widgets}

> **Résumé rapide** : cette page explique les widgets mobiles dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les widgets mobiles de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour les widgets mobiles.
