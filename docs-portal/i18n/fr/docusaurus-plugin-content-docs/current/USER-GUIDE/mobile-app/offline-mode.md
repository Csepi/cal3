...
description: "Conseils étape par étape pour le mode hors ligne dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique le mode hors ligne dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer le mode hors ligne de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le mode hors ligne.
