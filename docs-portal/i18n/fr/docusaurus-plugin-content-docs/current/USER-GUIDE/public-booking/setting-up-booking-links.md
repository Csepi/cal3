---
title: "Configuration des liens de réservation"
description: "Conseils étape par étape pour configurer les liens de réservation dans PrimeCalendar."
...
# Configuration des liens de réservation {#setting-up-booking-links}

> **Résumé rapide** : cette page explique la configuration des liens de réservation dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour finaliser la configuration des liens de réservation de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour configurer les liens de réservation.
...
- `05-USER-GUIDES/public-booking-guide.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/public-booking/setting-up-booking-links.md - Instantané archivé : archives/pre-consolidation/05-USER-GUIDES/public-booking-guide.md
