...
description: "Des conseils étape par étape pour gérer les réservations dans PrimeCalendar."
...
# Gestion des réservations {#managing-bookings}

> **Résumé rapide** : cette page explique la gestion des réservations dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la gestion des réservations de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour gérer les réservations.
...
- `03-FEATURES/public-booking.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/public-booking/managing-bookings.md - Instantané archivé : archives/pre-consolidation/03-FEATURES/public-booking.md
