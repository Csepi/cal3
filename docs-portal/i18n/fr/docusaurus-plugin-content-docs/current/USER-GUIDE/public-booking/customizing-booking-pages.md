---
title: "Personnalisation des pages de réservation"
description: "Des conseils étape par étape pour personnaliser les pages de réservation dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, public, booking, customizing, pages, primecalendar]
---

# Personnalisation des pages de réservation {#customizing-booking-pages}

> **Résumé rapide** : cette page explique la personnalisation des pages de réservation dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la personnalisation des pages de réservation de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour personnaliser les pages de réservation.
