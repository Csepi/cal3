---
title: "Questions et formulaires de réservation"
description: "Des conseils étape par étape pour les questions et les formulaires de réservation dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, public, booking, questions, and, forms, primecalendar]
---

# Questions et formulaires de réservation {#booking-questions-and-forms}

> **Résumé rapide** : cette page explique les questions et les formulaires de réservation dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour remplir de manière fiable les questions et les formulaires de réservation. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les questions et les formulaires de réservation.
