---
title: "Suppression de calendriers"
description: "Conseils étape par étape pour supprimer des calendriers dans PrimeCalendar."
...
# Suppression de calendriers {#deleting-calendars}

> **Résumé rapide** : cette page explique la suppression d'agendas dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la suppression des calendriers de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour supprimer des agendas.
