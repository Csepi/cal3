---
title: "Gestion de plusieurs calendriers"
description: "Conseils étape par étape pour gérer plusieurs calendriers dans PrimeCalendar."
...
# Gestion de plusieurs calendriers {#managing-multiple-calendars}

> **Résumé rapide** : cette page explique la gestion de plusieurs calendriers dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la gestion fiable de plusieurs calendriers. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour gérer plusieurs calendriers.
...
- `03-FEATURES/calendar-management.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/calendars/managing-multiple-calendars.md - Instantané archivé : archives/pre-consolidation/03-FEATURES/calendar-management.md
