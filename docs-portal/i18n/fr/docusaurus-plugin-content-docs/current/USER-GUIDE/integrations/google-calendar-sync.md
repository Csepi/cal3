---
title: "Synchronisation du calendrier Google"
description: "Conseils étape par étape pour la synchronisation du calendrier Google dans PrimeCalendar."
...
# Synchronisation du calendrier Google {#google-calendar-sync}

> **Résumé rapide** : cette page explique la synchronisation du calendrier Google dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer la synchronisation du calendrier Google de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour la synchronisation du calendrier Google.
