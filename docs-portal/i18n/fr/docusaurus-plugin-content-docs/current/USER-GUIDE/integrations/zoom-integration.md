---
title: "Intégration de Zoom"
description: "Conseils étape par étape pour l’intégration du zoom dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, integrations, zoom, integration, primecalendar]
---

# Intégration de Zoom {#zoom-integration}

> **Résumé rapide** : cette page explique l'intégration du zoom dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer l’intégration du zoom de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'intégration de Zoom.
