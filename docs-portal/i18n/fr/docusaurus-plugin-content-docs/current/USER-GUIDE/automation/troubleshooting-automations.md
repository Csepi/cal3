---
title: "Dépannage des automatisations"
description: "Conseils étape par étape pour dépanner les automatisations dans PrimeCalendar."
...
# Dépannage des automatisations {#troubleshooting-automations}

> **Résumé rapide** : cette page explique le dépannage des automatisations dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des automatisations de dépannage de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour dépanner les automatisations.
