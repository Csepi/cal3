---
title: "Valeurs intelligentes"
description: "Conseils étape par étape pour les valeurs intelligentes dans PrimeCalendar."
...
# Valeurs intelligentes {#smart-values}

> **Résumé rapide** : cette page explique les valeurs intelligentes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les valeurs intelligentes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour des valeurs intelligentes.
...
- `automation-smart-values.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/automation/smart-values.md - Instantané archivé : archives/pre-consolidation/automation-smart-values.md
