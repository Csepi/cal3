---
title: "Événements toute la journée"
description: "Conseils étape par étape pour les événements d’une journée entière dans PrimeCalendar."
...
# Événements toute la journée {#all-day-events}

> **Résumé rapide** : cette page explique les événements d'une journée entière dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer des événements d’une journée de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les événements qui durent toute la journée.
