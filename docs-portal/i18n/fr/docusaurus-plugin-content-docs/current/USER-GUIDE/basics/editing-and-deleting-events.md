---
title: "Modification et suppression d'événements"
description: "Conseils étape par étape pour modifier et supprimer des événements dans PrimeCalendar."
...
# Modification et suppression d'événements {#editing-and-deleting-events}

> **Résumé rapide** : cette page explique la modification et la suppression d'événements dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la modification et la suppression d’événements de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour modifier et supprimer des événements.
