...
description: "Conseils étape par étape pour naviguer dans le calendrier dans PrimeCalendar."
...
# Parcourir le calendrier {#navigating-the-calendar}

> **Résumé rapide** : cette page explique la navigation dans le calendrier dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la navigation dans le calendrier de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour naviguer dans le calendrier.
...
- `05-USER-GUIDES/basic-usage.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/basics/navigating-the-calendar.md - Instantané archivé : archives/pre-consolidation/05-USER-GUIDES/basic-usage.md
