...
description: "Conseils étape par étape pour rechercher des événements dans PrimeCalendar."
...
# Recherche d'événements {#searching-events}

> **Résumé rapide** : cette page explique la recherche d'événements dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des recherches d’événements de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour rechercher des événements.
