---
title: "Partager des calendriers"
description: "Conseils étape par étape pour partager des calendriers dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, sharing, and, collaboration, calendars, primecalendar]
---

# Partager des calendriers {#sharing-calendars}

> **Résumé rapide** : cette page explique le partage de calendriers dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le partage de calendriers de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour partager des calendriers.
