---
title: "Accepter les calendriers partagés"
description: "Conseils étape par étape pour accepter les calendriers partagés dans PrimeCalendar."
...
# Accepter les calendriers partagés {#accepting-shared-calendars}

> **Résumé rapide** : cette page explique l'acceptation des calendriers partagés dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour finaliser l'acceptation des calendriers partagés de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour accepter les calendriers partagés.
