---
title: "Publication du calendrier public"
description: "Conseils étape par étape pour la publication d’un calendrier public dans PrimeCalendar."
...
# Publication du calendrier public {#public-calendar-publishing}

> **Résumé rapide** : cette page explique la publication d'un calendrier public dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer la publication d’un calendrier public de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la publication d'agendas publics.
