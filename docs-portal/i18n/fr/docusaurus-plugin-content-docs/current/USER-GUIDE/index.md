...
description: "Workflows PrimeCal quotidiens pour les paramètres de profil, les calendriers, les tâches, l'automatisation, la synchronisation externe, les agents IA et les journaux personnels."
...
<div class="pc-guide-hero">
  ...
  <p class="pc-guide-hero__lead">Cette section suit le parcours normal PrimeCal après l'inscription : configuration du profil, travail sur le calendrier, création d'événements, tâches, automatisation, synchronisation externe, agents IA et journaux personnels.</p>
  <div class="pc-guide-chip-row">
    <span class="pc-guide-chip">Utilisateur uniquement</span>
    <span class="pc-guide-chip">Étiquettes actuelles de l'interface utilisateur</span>
    <span class="pc-guide-chip">Captures d'écran réelles</span>
    <span class="pc-guide-chip">Liens développeurs séparés</span>
  </div>
</div>
...
Les zones principales du calendrier et des tâches sont visibles dans l'espace de travail supérieur. Des outils plus avancés sont rassemblés sous `More`.

![PrimeCal Menu Plus affichant l'accès aux fonctionnalités avancées](../assets/user-guide/navigation/more-menu-feature-navigation.png)

## Ordre de lecture recommandé {#recommended-reading-order}

1. [Page de profil](./profile/profile-page.md)
2. [Espace de travail du calendrier](./calendars/calendar-workspace.md)
3. [Création d'événements](./basics/creating-events.md)
4. [Vues du calendrier](./basics/calendar-views.md)
5. [Espace de travail des tâches](./tasks/tasks-workspace.md)
6. [Introduction à l'automatisation](./automation/introduction-to-automation.md)
7. [Synchronisation externe](./integrations/external-sync.md)
8. [Configuration de l'agent](./agents/agent-configuration.md)
9. [Journaux personnels](./privacy/personal-logs.md)

## Détails du développeur {#developer-details}

Le guide de l'utilisateur reste intentionnellement axé sur le produit. Si vous avez besoin de contrats de point de terminaison, de restrictions ou d'exemples de requêtes, poursuivez avec la [Documentation du développeur](../DEVELOPER-GUIDE/index.md).
