---
title: "Langue et paramètres régionaux"
description: "Conseils étape par étape pour la langue et les paramètres régionaux dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, personalization, language, and, locale, primecalendar]
---

# Langue et paramètres régionaux {#language-and-locale}

> **Résumé rapide** : cette page explique la langue et les paramètres régionaux dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la langue et les paramètres régionaux de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent en termes de langue et de paramètres régionaux.
