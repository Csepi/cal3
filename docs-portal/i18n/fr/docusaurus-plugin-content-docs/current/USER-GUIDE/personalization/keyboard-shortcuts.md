...
description: "Conseils étape par étape pour les raccourcis clavier dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique les raccourcis clavier dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des raccourcis clavier de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour les raccourcis clavier.
