...
description: "Conseils étape par étape pour les formats de date et d'heure dans PrimeCalendar."
...
# Formats de date et d'heure {#date-time-formats}

> **Résumé rapide** : cette page explique les formats de date et d'heure dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les formats de date et d’heure de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les formats de date et d'heure.
