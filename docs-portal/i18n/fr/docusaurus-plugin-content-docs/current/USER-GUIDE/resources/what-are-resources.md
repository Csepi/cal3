---
title: "Que sont les ressources"
description: "Des conseils étape par étape sur ce que sont les ressources dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [user, resources, what, are, primecalendar]
---

# Que sont les ressources {#what-are-resources}

> **Résumé rapide** : cette page explique ce que sont les ressources dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les ressources de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour ce que sont les ressources.
