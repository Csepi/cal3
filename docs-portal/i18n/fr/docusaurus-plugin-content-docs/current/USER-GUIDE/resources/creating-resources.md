...
description: "Conseils étape par étape pour créer des ressources dans PrimeCalendar."
...
# Création de ressources {#creating-resources}

> **Résumé rapide** : cette page explique la création de ressources dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la création de ressources de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour créer des ressources.
