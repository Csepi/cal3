...
description: "Conseils étape par étape pour la disponibilité des ressources dans PrimeCalendar."
...
# Disponibilité des ressources {#resource-availability}

> **Résumé rapide** : cette page explique la disponibilité des ressources dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la disponibilité des ressources de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la disponibilité des ressources.
