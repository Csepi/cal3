---
title: "Gestion des participants externes"
description: "Des conseils étape par étape pour gérer les participants externes dans PrimeCalendar."
...
# Gestion des participants externes {#managing-external-attendees}

> **Résumé rapide** : cette page explique la gestion des participants externes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la gestion fiable des participants externes. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour gérer les participants externes.
