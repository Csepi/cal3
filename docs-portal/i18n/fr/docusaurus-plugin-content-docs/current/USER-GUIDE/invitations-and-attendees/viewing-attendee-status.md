---
title: "Affichage du statut des participants"
description: "Conseils étape par étape pour afficher le statut des participants dans PrimeCalendar."
...
# Affichage du statut des participants {#viewing-attendee-status}

> **Résumé rapide** : cette page explique l'affichage du statut des participants dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter l'affichage du statut des participants de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour afficher le statut des participants.
