...
description: "Conseils étape par étape pour la configuration des heures de travail dans PrimeCalendar."
...
# Configuration des heures de travail {#working-hours-configuration}

> **Résumé rapide** : cette page explique la configuration des heures de travail dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour finaliser la configuration des heures de travail de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour la configuration des heures de travail.
