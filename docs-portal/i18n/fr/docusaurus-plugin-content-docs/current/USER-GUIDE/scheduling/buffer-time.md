---
title: "Temps tampon"
description: "Conseils étape par étape pour le temps tampon dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique le temps de mise en mémoire tampon dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le temps de mise en mémoire tampon de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pendant le temps tampon.
