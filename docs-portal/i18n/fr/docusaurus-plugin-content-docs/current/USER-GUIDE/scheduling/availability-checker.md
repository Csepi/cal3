...
description: "Conseils étape par étape pour le vérificateur de disponibilité dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique le vérificateur de disponibilité dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le vérificateur de disponibilité de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le vérificateur de disponibilité.
