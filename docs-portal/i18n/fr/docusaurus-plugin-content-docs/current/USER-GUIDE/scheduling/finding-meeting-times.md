---
title: "Trouver des heures de réunion"
description: "Des conseils étape par étape pour trouver des heures de réunion dans PrimeCalendar."
...
# Trouver des heures de réunion {#finding-meeting-times}

> **Résumé rapide** : cette page explique la recherche d'heures de réunion dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la recherche des heures de réunion de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour trouver des heures de réunion.
