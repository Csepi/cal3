...
description: "Conseils étape par étape pour les paramètres de notification dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique les paramètres de notification dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les paramètres de notification de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les paramètres de notification.
...
- `03-FEATURES/notifications.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : USER-GUIDE/notifications/notification-settings.md - Instantané archivé : archives/pre-consolidation/03-FEATURES/notifications.md
