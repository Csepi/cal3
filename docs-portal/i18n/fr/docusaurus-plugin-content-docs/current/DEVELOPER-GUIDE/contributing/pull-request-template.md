---
title: "Modèle de demande de tirage"
description: "Conseils étape par étape pour le modèle de demande d'extraction dans PrimeCalendar."
...
# Modèle de demande de tirage {#pull-request-template}

> **Résumé rapide** : cette page explique le modèle de demande d'extraction dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le modèle de demande de tirage de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le modèle de demande d'extraction.
