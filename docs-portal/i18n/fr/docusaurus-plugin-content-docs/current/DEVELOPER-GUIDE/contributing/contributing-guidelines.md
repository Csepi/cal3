---
title: "Lignes directrices de contribution"
description: "Des conseils étape par étape pour contribuer aux directives dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique les directives de contribution dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les directives de contribution de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour contribuer aux directives.
