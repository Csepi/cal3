...
description: "Conseils étape par étape pour signaler les problèmes dans PrimeCalendar."
...
# Signalement de problèmes {#issue-reporting}

> **Résumé rapide** : cette page explique le signalement des problèmes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des rapports de problèmes de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour signaler les problèmes.
