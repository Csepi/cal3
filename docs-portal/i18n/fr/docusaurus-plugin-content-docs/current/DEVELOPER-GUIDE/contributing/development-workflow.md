...
description: "Conseils étape par étape pour le flux de travail de développement dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique le flux de travail de développement dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer le flux de travail de développement de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour le flux de travail de développement.
...
- `security/repo-hygiene.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/contributing/development-workflow.md - Instantané archivé : archives/pre-consolidation/security/repo-hygiene.md
