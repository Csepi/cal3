...
description: "Conseils étape par étape pour la configuration de la base de données dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la configuration de la base de données dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la configuration de la base de données de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la configuration de la base de données.
...
- `database/SECURITY_OPTIMIZATION.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/database/database-setup.md - Instantané archivé : archives/pre-consolidation/database/SECURITY_OPTIMIZATION.md
