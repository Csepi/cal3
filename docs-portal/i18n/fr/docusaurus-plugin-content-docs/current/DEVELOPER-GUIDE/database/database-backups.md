...
description: "Conseils étape par étape pour les sauvegardes de bases de données dans PrimeCalendar."
...
# Sauvegardes de base de données {#database-backups}

> **Résumé rapide** : cette page explique les sauvegardes de base de données dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des sauvegardes de bases de données de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour les sauvegardes de bases de données.
