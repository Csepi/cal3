---
title: "Migrations"
description: "Conseils étape par étape pour les migrations dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique les migrations dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer les migrations de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les migrations.
...
- `06-DEVELOPER-GUIDES/database-migrations.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/database/migrations.md - Instantané archivé : archives/pre-consolidation/06-DEVELOPER-GUIDES/database-migrations.md
