...
description: "Conseils étape par étape pour la sécurité au niveau des lignes dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la sécurité au niveau des lignes dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer de manière fiable la sécurité au niveau des lignes. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la sécurité au niveau des lignes.
