...
description: "Conseils étape par étape pour l’exécution locale dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique l'exécution locale dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer une exécution locale de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour fonctionner localement.
