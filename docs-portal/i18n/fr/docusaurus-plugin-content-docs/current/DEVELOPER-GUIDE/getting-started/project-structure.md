...
description: "Des conseils étape par étape pour la structure du projet dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la structure du projet dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la structure du projet de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la structure du projet.
...
- `06-DEVELOPER-GUIDES/code-organization.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/getting-started/project-structure.md - Instantané archivé : archives/pre-consolidation/06-DEVELOPER-GUIDES/code-organization.md
