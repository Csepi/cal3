...
description: "Conseils étape par étape pour la configuration de l’environnement de développement dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, getting, started, development, environment, setup, primecalendar]
---

# Configuration de l'environnement de développement {#development-environment-setup}

> **Résumé rapide** : cette page explique la configuration de l'environnement de développement dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la configuration de l’environnement de développement de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la configuration de l'environnement de développement.
...
- `06-DEVELOPER-GUIDES/local-setup.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/getting-started/development-environment-setup.md - Instantané archivé : archives/pre-consolidation/06-DEVELOPER-GUIDES/local-setup.md
