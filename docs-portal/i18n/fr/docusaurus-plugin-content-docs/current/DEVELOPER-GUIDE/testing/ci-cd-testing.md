---
title: "Test de Cd Ci"
description: "Conseils étape par étape pour les tests ci cd dans PrimeCalendar."
...
# Test de Cd Ci {#ci-cd-testing}

> **Résumé rapide** : cette page explique les tests ci cd dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer les tests ci cd de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les tests ci cd.
