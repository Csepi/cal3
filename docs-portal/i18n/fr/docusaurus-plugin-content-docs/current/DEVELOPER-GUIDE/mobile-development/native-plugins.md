---
title: "Plugins natifs"
description: "Conseils étape par étape pour les plugins natifs dans PrimeCalendar."
...
# Plugins natifs {#native-plugins}

> **Résumé rapide** : cette page explique les plugins natifs dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les plugins natifs de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour les plugins natifs.
