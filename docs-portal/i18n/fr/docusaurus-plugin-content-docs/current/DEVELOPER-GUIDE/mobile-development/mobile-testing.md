---
title: "Tests mobiles"
description: "Conseils étape par étape pour les tests mobiles dans PrimeCalendar."
...
# Tests mobiles {#mobile-testing}

> **Résumé rapide** : cette page explique les tests mobiles dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des tests mobiles de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les tests mobiles.
