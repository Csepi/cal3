---
title: "Configuration du condensateur"
description: "Conseils étape par étape pour la configuration du condensateur dans PrimeCalendar."
...
# Configuration du condensateur {#capacitor-setup}

> **Résumé rapide** : Cette page explique la configuration du condensateur dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la configuration du condensateur de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour la configuration des condensateurs.
