---
title: "Fonctionnalités spécifiques aux mobiles"
description: "Conseils étape par étape pour les fonctionnalités spécifiques aux mobiles dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [developer, mobile, development, specific, features, primecalendar]
---

# Fonctionnalités spécifiques aux mobiles {#mobile-specific-features}

> **Résumé rapide** : cette page explique les fonctionnalités spécifiques aux mobiles dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter de manière fiable les fonctionnalités spécifiques aux mobiles. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les fonctionnalités spécifiques aux mobiles.
