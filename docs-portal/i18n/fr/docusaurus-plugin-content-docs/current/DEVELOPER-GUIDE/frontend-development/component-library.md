...
description: "Conseils étape par étape pour la bibliothèque de composants dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la bibliothèque de composants dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la bibliothèque de composants de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la bibliothèque de composants.
...
- `UI_IMPROVEMENTS_IMPLEMENTATION_GUIDE.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/frontend-development/component-library.md - Instantané archivé : archives/pre-consolidation/UI_IMPROVEMENTS_IMPLEMENTATION_GUIDE.md
