---
title: "Tests frontaux"
description: "Conseils étape par étape pour les tests frontend dans PrimeCalendar."
...
# Tests frontaux {#frontend-testing}

> **Résumé rapide** : cette page explique les tests frontaux dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer les tests frontaux de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les tests frontaux.
