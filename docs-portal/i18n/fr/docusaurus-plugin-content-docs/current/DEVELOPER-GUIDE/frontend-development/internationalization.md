...
description: "Conseils étape par étape pour l’internationalisation dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique l'internationalisation dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer l’internationalisation de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour l'internationalisation.
