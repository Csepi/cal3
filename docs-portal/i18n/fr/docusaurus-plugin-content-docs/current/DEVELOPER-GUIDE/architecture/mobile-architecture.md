...
description: "Conseils étape par étape pour l’architecture mobile dans PrimeCalendar."
...
# Architecture mobile {#mobile-architecture}

> **Résumé rapide** : cette page explique l'architecture mobile dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter l’architecture mobile de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'architecture mobile.
