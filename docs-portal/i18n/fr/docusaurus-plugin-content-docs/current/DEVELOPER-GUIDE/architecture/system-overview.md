...
description: "Conseils étape par étape pour la présentation du système dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la présentation du système dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la présentation du système de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la vue d'ensemble du système.
...
- `02-ARCHITECTURE/system-overview.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/architecture/system-overview.md - Instantané archivé : archives/pre-consolidation/02-ARCHITECTURE/system-overview.md
- `architecture/agent-integration-plan.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/architecture/system-overview.md - Instantané archivé : archives/pre-consolidation/architecture/agent-integration-plan.md
