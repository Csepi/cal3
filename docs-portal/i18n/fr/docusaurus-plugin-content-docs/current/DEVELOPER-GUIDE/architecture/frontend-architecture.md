---
title: "Architecture frontale"
description: "Conseils étape par étape pour l’architecture frontend dans PrimeCalendar."
...
# Architecture frontale {#frontend-architecture}

> **Résumé rapide** : cette page explique l'architecture frontale dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter l’architecture frontend de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour l'architecture frontend.
...
- `02-ARCHITECTURE/frontend-structure.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/architecture/frontend-architecture.md - Instantané archivé : archives/pre-consolidation/02-ARCHITECTURE/frontend-structure.md
