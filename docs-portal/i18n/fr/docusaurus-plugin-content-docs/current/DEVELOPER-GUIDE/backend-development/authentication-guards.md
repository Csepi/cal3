---
title: "Gardes d'authentification"
description: "Conseils étape par étape pour les gardes d’authentification dans PrimeCalendar."
...
# Gardes d'authentification {#authentication-guards}

> **Résumé rapide** : cette page explique les gardes d'authentification dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les gardes d’authentification de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent de la part des agents d'authentification.
