---
title: "Modules Nestjs"
description: "Conseils étape par étape pour les modules nestjs dans PrimeCalendar."
...
# Modules Nestjs {#nestjs-modules}

> **Résumé rapide** : cette page explique les modules nestjs dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les modules nestjs de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les modules nestjs.
...
- `06-DEVELOPER-GUIDES/adding-endpoints.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/backend-development/nestjs-modules.md - Instantané archivé : archives/pre-consolidation/06-DEVELOPER-GUIDES/adding-endpoints.md
