...
description: "Conseils étape par étape pour l’accès à la base de données dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique l'accès à la base de données dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour accéder de manière fiable à la base de données. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'accès à la base de données.
