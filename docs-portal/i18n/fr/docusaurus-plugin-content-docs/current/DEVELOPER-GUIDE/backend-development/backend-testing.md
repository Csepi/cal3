---
title: "Tests back-end"
description: "Conseils étape par étape pour les tests backend dans PrimeCalendar."
...
# Tests back-end {#backend-testing}

> **Résumé rapide** : cette page explique les tests backend dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des tests backend de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les tests backend.
