---
title: "Autorisation Décorateurs"
description: "Conseils étape par étape pour les décorateurs d’autorisation dans PrimeCalendar."
...
# Autorisation Décorateurs {#authorization-decorators}

> **Résumé rapide** : cette page explique les décorateurs d'autorisation dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les autorisations des décorateurs de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent de la part des décorateurs d'autorisation.
