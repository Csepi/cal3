---
title: "Actions d'automatisation personnalisées"
description: "Conseils étape par étape pour les actions d'automatisation personnalisées dans PrimeCalendar."
...
# Actions d'automatisation personnalisées {#custom-automation-actions}

> **Résumé rapide** : cette page explique les actions d'automatisation personnalisées dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des actions d'automatisation personnalisées de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les actions d'automatisation personnalisées.
