---
title: "Consommateurs de webhooks"
description: "Conseils étape par étape pour les consommateurs de webhooks dans PrimeCalendar."
...
# Consommateurs de webhooks {#webhook-consumers}

> **Résumé rapide** : cette page explique les consommateurs de webhooks dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les consommateurs de webhooks de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les consommateurs de webhooks.
...
- `03-FEATURES/agents.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/extending-primecalendar/webhook-consumers.md - Instantané archivé : archives/pre-consolidation/03-FEATURES/agents.md
- `06-DEVELOPER-GUIDES/mcp-development.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/extending-primecalendar/webhook-consumers.md - Instantané archivé : archives/pre-consolidation/06-DEVELOPER-GUIDES/mcp-development.md
- `agents/setup.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/extending-primecalendar/webhook-consumers.md - Instantané archivé : archives/pre-consolidation/agents/setup.md
- `agents/usage.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/extending-primecalendar/webhook-consumers.md - Instantané archivé : archives/pre-consolidation/agents/usage.md
