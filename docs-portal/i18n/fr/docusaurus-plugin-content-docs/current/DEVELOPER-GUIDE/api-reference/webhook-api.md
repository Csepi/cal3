---
title: "Webhook API"
description: "Conseils étape par étape pour l’API webhook dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique l'API webhook dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter l’API webhook de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'API webhook.
...
- `04-API-REFERENCE/agents.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : DEVELOPER-GUIDE/api-reference/webhook-api.md - Instantané archivé : archives/pre-consolidation/04-API-REFERENCE/agents.md
