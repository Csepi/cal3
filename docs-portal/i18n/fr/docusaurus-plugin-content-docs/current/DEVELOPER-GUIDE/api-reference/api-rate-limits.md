---
title: "API Limites de débit"
description: "Conseils étape par étape pour les limites de débit API dans PrimeCalendar."
...
# API Limites de débit {#api-rate-limits}

> **Résumé rapide** : cette page explique les limites de débit API dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les limites de débit API de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour les limites de débit de l'API.
