---
title: "Hiérarchies des départements"
description: "Conseils étape par étape pour les hiérarchies de départements dans PrimeCalendar."
...
# Hiérarchies des départements {#department-hierarchies}

> **Résumé rapide** : cette page explique les hiérarchies de services dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les hiérarchies de services de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les hiérarchies de services.
