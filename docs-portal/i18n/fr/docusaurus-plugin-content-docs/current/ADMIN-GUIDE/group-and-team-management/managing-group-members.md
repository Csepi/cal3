...
description: "Conseils étape par étape pour gérer les membres du groupe dans PrimeCalendar."
...
# Gestion des membres du groupe {#managing-group-members}

> **Résumé rapide** : cette page explique la gestion des membres du groupe dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la gestion fiable des membres du groupe. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour gérer les membres du groupe.
