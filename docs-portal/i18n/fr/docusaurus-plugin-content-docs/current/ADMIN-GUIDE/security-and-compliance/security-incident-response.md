...
description: "Conseils étape par étape pour la réponse aux incidents de sécurité dans PrimeCalendar."
...
# Réponse aux incidents de sécurité {#security-incident-response}

> **Résumé rapide** : cette page explique la réponse aux incidents de sécurité dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour répondre de manière fiable aux incidents de sécurité. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour répondre aux incidents de sécurité.
...
- `compliance/INCIDENT_RESPONSE.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : ADMIN-GUIDE/security-and-compliance/security-incident-response.md - Instantané archivé : archives/pre-consolidation/compliance/INCIDENT_RESPONSE.md
