---
title: "Conformité SOC2"
description: "Conseils étape par étape pour la conformité soc2 dans PrimeCalendar."
...
# Conformité SOC2 {#soc2-compliance}

> **Résumé rapide** : cette page explique la conformité soc2 dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour assurer la conformité soc2 de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la conformité soc2.
...
- `security/asvs-matrix.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : ADMIN-GUIDE/security-and-compliance/soc2-compliance.md - Instantané archivé : archives/pre-consolidation/security/asvs-matrix.md
