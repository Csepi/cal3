...
description: "Conseils étape par étape pour la journalisation d’audit dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la journalisation d'audit dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer une journalisation d’audit de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la journalisation d'audit.
...
- `compliance/CONTROLS_EVIDENCE.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : ADMIN-GUIDE/security-and-compliance/audit-logging.md - Instantané archivé : archives/pre-consolidation/compliance/CONTROLS_EVIDENCE.md
