...
description: "Conseils étape par étape pour les politiques de conservation des données dans PrimeCalendar."
...
# Politiques de conservation des données {#data-retention-policies}

> **Résumé rapide** : cette page explique les politiques de conservation des données dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour mettre en œuvre les politiques de conservation des données de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent en matière de politiques de conservation des données.
