...
description: "Conseils étape par étape pour la conformité au RGPD dans PrimeCalendar."
...
> **Résumé rapide** : cette page explique la conformité au RGPD dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour vous conformer de manière fiable au RGPD. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour se conformer au RGPD.
...
- `compliance/GDPR_MODULE.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : ADMIN-GUIDE/security-and-compliance/gdpr-compliance.md - Instantané archivé : archives/pre-consolidation/compliance/GDPR_MODULE.md
