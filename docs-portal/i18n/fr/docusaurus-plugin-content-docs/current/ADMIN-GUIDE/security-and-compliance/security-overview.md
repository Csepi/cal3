...
description: "Conseils étape par étape pour une présentation de la sécurité dans PrimeCalendar."
...
# Présentation de la sécurité {#security-overview}

> **Résumé rapide** : cette page explique la présentation de la sécurité dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter la présentation de la sécurité de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour une vue d'ensemble de la sécurité.
...
- `security/API_SECURITY.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : ADMIN-GUIDE/security-and-compliance/security-overview.md - Instantané archivé : archives/pre-consolidation/security/API_SECURITY.md
- `security/INPUT_VALIDATION.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : ADMIN-GUIDE/security-and-compliance/security-overview.md - Instantané archivé : archives/pre-consolidation/security/INPUT_VALIDATION.md
- `security/WEBHOOK_SECURITY.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : ADMIN-GUIDE/security-and-compliance/security-overview.md - Instantané archivé : archives/pre-consolidation/security/WEBHOOK_SECURITY.md
