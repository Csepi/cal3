...
description: "Conseils étape par étape pour l’analyse des événements dans PrimeCalendar."
...
# Analyse d'événements {#event-analytics}

> **Résumé rapide** : cette page explique l'analyse des événements dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des analyses d’événements de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'analyse des événements.
