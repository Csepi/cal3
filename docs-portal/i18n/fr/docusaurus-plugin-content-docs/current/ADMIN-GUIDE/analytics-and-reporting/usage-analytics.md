...
description: "Conseils étape par étape pour l’analyse de l’utilisation dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, analytics, and, reporting, usage, primecalendar]
---

# Analyse d'utilisation {#usage-analytics}

> **Résumé rapide** : cette page explique les analyses d'utilisation dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des analyses d'utilisation de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'analyse de l'utilisation.
