...
description: "Conseils étape par étape pour les factures et les reçus dans PrimeCalendar."
...
# Factures et reçus {#invoices-and-receipts}

> **Résumé rapide** : cette page explique les factures et les reçus dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter les factures et les reçus de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour les factures et les reçus.
