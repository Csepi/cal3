...
description: "Conseils étape par étape pour la gestion de la facturation dans PrimeCalendar."
...
# Gestion de la facturation {#billing-management}

> **Résumé rapide** : cette page explique la gestion de la facturation dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer la gestion de la facturation de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour la gestion de la facturation.
