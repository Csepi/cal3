---
title: "Gestion multi-organisations"
description: "Conseils étape par étape pour la gestion multi-organisations dans PrimeCalendar."
...
# Gestion multi-organisations {#multi-organization-management}

> **Résumé rapide** : cette page explique la gestion multi-organisations dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer une gestion multi-organisations de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour la gestion multi-organisations.
...
- `03-FEATURES/multi-tenancy.md` : Cette page a été déplacée vers la structure consolidée. - Page canonique : ADMIN-GUIDE/organization-management/multi-organization-management.md - Instantané archivé : archives/pre-consolidation/03-FEATURES/multi-tenancy.md
