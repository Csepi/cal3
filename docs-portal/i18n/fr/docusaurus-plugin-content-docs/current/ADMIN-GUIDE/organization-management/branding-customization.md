...
description: "Conseils étape par étape pour la personnalisation de la marque dans PrimeCalendar."
...
# Personnalisation de la marque {#branding-customization}

> **Résumé rapide** : cette page explique la personnalisation de la marque dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour finaliser la personnalisation de la marque de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la personnalisation de la marque.
