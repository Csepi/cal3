---
title: "Activation des fonctionnalités bêta"
description: "Conseils étape par étape pour activer les fonctionnalités bêta dans PrimeCalendar."
...
# Activation des fonctionnalités bêta {#enabling-beta-features}

> **Résumé rapide** : cette page explique l'activation des fonctionnalités bêta dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer l’activation des fonctionnalités bêta de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour activer les fonctionnalités bêta.
