...
description: "Conseils étape par étape pour le répertoire des utilisateurs dans PrimeCalendar."
...
related:
  - ../index.md
  - ../../index.md
tags: [admin, user, management, directory, primecalendar]
---

# Annuaire des utilisateurs {#user-directory}

> **Résumé rapide** : cette page explique le répertoire des utilisateurs dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter le répertoire des utilisateurs de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : Votre équipe a besoin d'un comportement cohérent pour l'annuaire des utilisateurs.
