...
description: "Conseils étape par étape pour désactiver les utilisateurs dans PrimeCalendar."
...
# Désactiver des utilisateurs {#deactivating-users}

> **Résumé rapide** : cette page explique la désactivation des utilisateurs dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour terminer la désactivation des utilisateurs de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour désactiver les utilisateurs.
