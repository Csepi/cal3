---
title: "Présentation des ressources d'administration"
description: "Conseils étape par étape pour la présentation des ressources d’administration dans PrimeCalendar."
...
# Présentation des ressources d'administration {#admin-resource-overview}

> **Résumé rapide** : cette page explique la présentation des ressources d'administration dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour compléter de manière fiable la présentation des ressources d’administration. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour la présentation des ressources administratives.
