...
description: "Conseils étape par étape pour l’analyse des ressources dans PrimeCalendar."
...
# Analyse des ressources {#resource-analytics}

> **Résumé rapide** : cette page explique l'analyse des ressources dans PrimeCalendar à l'aide d'étapes pratiques et de conseils de dépannage.
...
Utilisez ce guide pour effectuer des analyses de ressources de manière fiable. Confirmez les résultats attendus après chaque étape avant de passer aux paramètres avancés facultatifs.
...
**Scénario** : votre équipe a besoin d'un comportement cohérent pour l'analyse des ressources.
